	  ...
	  success: function(data) {
		...
		$.each(data.items, function(i,item){
			...
			if( Win ==undefined || Win.closed)
			{
				...
				Win=window.open('http://oh.learnbeyond.net/~oh/hcl/chat/teacher_online.php?emailid=' + emailId + '&schoolid=' +  schoolId ,'imchatteachwin','resizable=yes,scrollbars=yes,width=800,height=550,toolbars=no');
			}
