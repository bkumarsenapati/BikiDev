...
<tr>
<td>Enrollment Type </td><td>Price </td> <td> Includes</td>
</tr>
<tr>
<td>Credit Recovery </td><td>$300 per Course </td> <td>Teacher-monitored </td>
</tr>
<tr>
<td>Summer Enrichment</td><td>$125 per course</td> <td>Self-paced</td>
</tr>
</table> 
...
%>
<TR>
<TD width=177><span style="font-size:10pt;"><font face="Arial">School 
                                        </font></span></TD>
...
<TR>
	...
	<TD width=177 >
		<p><font face="Arial">Enrollment Type</font></p>
</TD>
<td width="26" align="center" valign="middle">&nbsp;</td>
 <td colspan="3">
         <input type="radio"  value="er" id="id_radio1" checked="checked" name="enroll" >&nbsp;Enrichment enrollment&nbsp;&nbsp;<input type="radio" id="id_radio2" value="cr" name="enroll">&nbsp;CreditRecovery enrollment&nbsp;
</TD>
</TR>
   ...
   <td width="191" height="27" align="left" valign="middle">State</td>
    ...
    <option value="ZW">Zimbabwe</option>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
    <td height="30"><h2 align="left"> Enter your Credit card details</h2></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="30" width="191">Expiry	</td>
      <td width="28" height="27" align="center" valign="middle">&nbsp;</td>
       ...
       Year <input name="ExpYear" size="2" maxlength="2" class="txtpnowid">
       yy
...
<tr>
    <td><table><tr>
        <td width="23" height="27" align="left" valign="middle">
            <p><input type="checkbox" name="spi" value="y" checked></p>
        </td>
...
<p>&nbsp;</p>
      ...
      <!--  <tr>
        ...
        <td colspan="5" width="604">
                ...
                <p align="center"><input type="submit" name="submit" value="Submit" class="button" > 
