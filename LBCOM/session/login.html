...
<div id="wapper">
  ...
  <div id="container">
   ...
   <span><img src="images/ico-phone.png" alt="Phone" width="20" height="16" hspace="2" /> Phone:</span>1-855-28-LEARN
            <span></span>(855-285-3276)
            <br/> <span><img src="images/ico-fax.png" alt="Fax" width="20" height="16" hspace="2" /> support:</span>732-658-5384&nbsp; <span><img src="images/ico-email.png" alt="Email" width="20" height="16" hspace="2" /> Email:</span> <a href="mailto:info@learnbeyond.com">info@learnbeyond.com</a></div>
   			 <!-- \ NAVIGATION PANEL / -->
	    ...
	    <div id="mainHeaderPanel42">
		  ...
		  <div class="headerRighBox1">
			<h2 style="padding:0;">Login<h6 ><b>Provides access to course content, assignments, assesments, practice center, calendar, e-conference, chat, bulletin board and other features.</b></h6> </h2>
...
<div style="margin:0; width:80%; padding:0;display:inline"></div>
	  ...
	  <div class="field text-field">
		...
		<div class="field">
	    <input name="user_session[remember_me]" type="hidden" value="0" /><input checked="checked" id="user_session_remember_me" name="selbox" type="checkbox" value="1" /> <label for="user_session_remember_me" class=">Keep me logged in</label>
	  </div>
	  <div class="actions">
	   ...
	   <div id="rightBox" style="width: 350px;">
        ...
        <h4> No Account yet? &nbsp; <a href="#"> Enroll Now </a></h4> 
        <br/><br/>
        ...
        <h6 style="color:#055b7f;">
         ...
         Learnbeyond is an effective platform that enables students to learn at their own pace, but also provides Unit Pretests to exempt students from previously-mastered concepts.</h6>
