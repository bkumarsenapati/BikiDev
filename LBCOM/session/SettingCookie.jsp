...
<body>
<%
	//System.out.println("In setting a cookie...before modifying user id."+userId);  
	userId=userId.replaceAll("_parent","");//replaces all occurrences of "is" to "was"  
	//System.out.println("In setting a cookie...after modified user id."+userId+".."+pwd);
