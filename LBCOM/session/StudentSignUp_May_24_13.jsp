...
<TR>
	...
	<TD width="191" >
		<font face="Arial">Enrollment Type</font>
</TD>
<td width="28" align="center" valign="middle">&nbsp;</td>
 <td colspan="3">
...
%>
		...
		<option value='C000'>Grade6</option>
		<option value='C000'>Grade7</option>
		<option value='C000'>Grade8</option>
		<option value='C000'>Grade9</option>
		<option value='C000'>Grade10</option>
		<option value='C000'>Grade11</option>
		<option value='C000'>Grade12</option>
		</select><font color="red">*</font></p>
        </td>
<%
	}
...
<table><tr>
        <td width="23" height="27" align="left" valign="middle">
            <p><input type="hidden" name="spi" value="y"></p>
        </td>
...
<p>&nbsp;</p>
		...
		<div id="div3">
<table style="margin: 0 220px 0 220px;">
	...
	<tr>
        ...
        <td width="23" height="27" align="left" valign="middle">
        <input type="checkbox" name="btpp" value="y" onClick="handleClick(this);">
        </td>
