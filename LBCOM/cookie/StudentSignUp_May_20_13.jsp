...
<%
 ...
 %>
<TR>
<TD  width=177><span style="font-size:10pt;"><font face="Arial">User ID</font></span></TD>
<td width="26" align="center" valign="middle">&nbsp;</td>
 <td colspan="3"><span style="font-size:10pt;"><font face="Arial">
	<INPUT maxLength="50" size=35 name="username" if="forms[0].USER_NAME"  oncontextmenu="return false" onkeypress="return UIDOnly(this, event)" ></font></span><font color="red">*</font></TD></TR>
   ...
   <td width="191" height="27" align="left" valign="middle">State</td>
    ...
    <option value="ZW">Zimbabwe</option>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
    <td height="30"><h2 align="center"> Enter your Credit card details</h2></td>
  </tr>
  <tr>
    <td height="30">Credit Card Number: </td>
  </tr>
  
  <tr>
    <td height="30"><input type="text" class="txtp"  name="CardNumber" value="" height="22" valign="middle" width="250" size="70"  />&nbsp;</td></tr>
    
    <tr>
    <td height="30">Card Type:</td>
  </tr> 
  ...
  <tr>
    <td height="30"> <select id="standard-dropdown" name="ExpMon" class="custom-class1 custom-class2">
	   ...
	   <select id="standard-dropdown1" name="ExpYear" class="custom-class1 custom-class2">
          <option value="01" selected="selected">13 </option>
...
<!-- 	   <input name="ExpYear" size="2" maxlength="2" class="txtpnowid">
 -->       yy
  ...
  <tr>
    <td height="30">Name on the Card: </td>
  </tr>
