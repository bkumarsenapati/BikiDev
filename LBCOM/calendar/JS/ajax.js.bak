...
function addEventHandler() {
	...
	var sdate="";
			...
			result+="<tr><td width=\"10%\" bgcolor=\"#429EDF\" align=\"center\"> <td width=\"90%\" bgcolor=\"#429EDF\">";
...
function getEventDetails(id,type,ddt)
{
	...
	document.getElementById("weak").innerHTML="&nbsp;";
	var items="";
	items="<center><table border=\"0\" cellspacing=\"0\" width=\"90%\" id=\"AutoNumber3\" bgcolor=\"#429EDF\" style=\"border-collapse: collapse\" bordercolor=\"#111111\" cellpadding=\"0\" ><tr><td width=\"50%\" align=\"left\" height=\"28\"><font face=\"Arial\" style=\"font-size: 12px;\"><b>&nbsp;<font color=\"#FFFFFF\" style=\"font-size: 12px;\">Event details </font></b></font></td><td width=\"50%\" height=\"24\" align=\"right\">";
	if(type=="day")
	{
