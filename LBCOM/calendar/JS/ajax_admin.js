		...
		var message=http.responseXML.getElementsByTagName("root");
			...
			for(i=0; i<message.length;i++)
			{
				...
				for(j=0;j<v.length;j++)
				{
					...
					result+="<tr><td align=\"left\" width=\"29%\" height=\"31\"><font face=\"Arial\" style=\"font-size: 12px;\">Event on</font></td><td width=\"1%\" height=\"31\" colspan=\"2\"><p align=\"right\">:</td>";
					if(title=='null')
					...
					if(sdate=="null")
						sdate="";
					result+="<tr><td align=\"left\" width=\"16%\" height=\"50\" rowspan=\"2\" valign=\"top\"><font face=\"Arial\" style=\"font-size: 12px;\">Dates </font></td><td align=\"left\" width=\"2%\" height=\"50\" rowspan=\"2\" colspan=\"2\" valign=\"top\"><p align=\"right\">:</td><td align=\"left\" width=\"82%\" height=\"13\"><font  face=\"Arial\" style=\"font-size: 12px;\">";
					
					result+="Start date &amp; Time&nbsp; :"+change_dt_format_norm(sdate)+"&nbsp;"+stime+"</font></td></tr>";
					...
					if(loc=='null')
					loc="";
					result+="<tr><td align=\"left\" width=\"16%\" height=\"19\"> <font face=\"Arial\" style=\"font-size: 12px;\">Location</font></td><td width=\"2%\" height=\"19\" colspan=\"2\"><p align=\"right\">:</td> <td align=\"left\" width=\"82%\" height=\"19\"><font face=\"Arial\" style=\"font-size: 12px;\">"+loc+"</font></td></tr>";

					if(desp=='null')
						desp="";
						result+="<tr><td align=\"left\" width=\"16%\" height=\"19\"><font face=\"Arial\" style=\"font-size: 12px;\">Description</font></td>      <td width=\"2%\" height=\"19\" colspan=\"2\"><p align=\"right\">:</td>";
					...
					if(Viewtype!="shared")
					{
						result+="<tr><td align=\"left\" width=\"16%\" height=\"19\"><font face=\"Arial\" style=\"font-size: 12px;\">Shared to</font></td>      <td width=\"2%\" height=\"19\" colspan=\"2\"><p align=\"right\">:</td>";
...
function addEventHandler() {
	...
	var sdate="";
			...
			result+="<tr><td width=\"10%\" bgcolor=\"#EEBA4D\" align=\"center\"> <td width=\"90%\" bgcolor=\"#EEBA4D\">";
			...
			for(i=0; i<message.length;i++)
			{
				...
				result+="<tr><td  width=\"10%\" height=\"50\" align=\"center\" valign=\"top\"></td><td width=\"90%\" height=\"50\"><table width=\"100%\">";
					...
					result+="<tr><td bgcolor=\"#EEE0A1\" width=\"10%\" height=\"50\" align=\"center\" valign=\"top\"><font face=\"Arial\" style=\"font-size: 12px;\" color=\"white\" style=\"bold\"><b>"+month_name+" "+day+"' "+yr.substring(2)+"<br\>"+day_name+"</b></font></td><td width=\"90%\" height=\"50\"><table width=\"100%\">";
				}
				var test=v.length;
				for(j=0;j<v.length;j++)
				{
					...
					if(desp=='null')
						result+="<td width=\"20%\" height=\"30\" valign=\"bottom\"> <a href=\"#\" onclick=\"del('"+uid+"','"+type+"','"+sdate+"')\"><img src=\"../../images/idelete.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Delete\"></a></td>";
					else
					result+="<td width=\"20%\" height=\"30\" align=\"left\" valign=\"bottom\"><a href=\"#\" onclick=\"del('"+uid+"','"+type+"','"+sdate+"')\" ><img src=\"../../images/idelete.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Delete\"></a>   <font face=\"Arial\" style=\"font-size: 12px;\"><a href=\"#\" onclick=\"getEventDetails('"+uid+"','"+type+"','"+sdate+"')\"  style=\"text-decoration:none\">"+desp+"</a></font></td>";
			...
			if(count<=0 && type=="allEvents")
				{
				result_share+="<tr><td colspan=\"5\" valign=\"top\" align=\"center\"> <font face=\"Arial\" style=\"font-size: 12px;\">No events are available!</font></td></tr>";
				result=result_share;
				}
			result+="</table>";
		...
		var message=http.responseXML.getElementsByTagName("root");
			...
			for(i=0; i<message.length;i++)
			{
				...
				for(j=0;j<v.length;j++)
				{
					...
					result+="<td width=\"20%\" height=\"30\" align=\"left\" valign=\"bottom\" ><a href=\"#\" onclick=\"del('"+uid+"','weak','"+sdate+"')\" ><img src=\"../../images/idelete.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Delete\"></a>   <font face=\"Arial\" style=\"font-size: 12px;\"><a href=\"#\" onclick=\"getEventDetails('"+uid+"','weak','"+sdate+"')\"  style=\"text-decoration:none\">"+desp+"</a></font></td>";
		...
		var message=http.responseXML.getElementsByTagName("root");
			...
			for(i=0; i<message.length;i++)
			{
				...
				for(j=0;j<v.length;j++)
				{
					...
					result+="<td width=\"20%\" height=\"30\" align=\"left\" valign=\"bottom\" ><a href=\"#\" onclick=\"del('"+uid+"','month','"+sdate+"')\" ><img src=\"../../images/idelete.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Delete\"></a>   <font face=\"Arial\" style=\"font-size: 12px;\">   <a href=\"#\" onclick=\"getEventDetails('"+uid+"','month','"+sdate+"')\"  style=\"text-decoration:none\">"+desp+"</a></font></td>";
...
function getEventDetails(id,type,ddt)
{
	...
	//document.getElementById("editview").style.visibility = "visible";
	document.getElementById("date").innerHTML="&nbsp;";
	document.getElementById("weak").innerHTML="&nbsp;";
	var items="";
	items="<center><table border=\"0\" cellspacing=\"0\" width=\"90%\" id=\"AutoNumber3\" bgcolor=\"#EEBA4D\" style=\"border-collapse: collapse\" bordercolor=\"#111111\" cellpadding=\"0\" ><tr><td width=\"50%\" align=\"left\" height=\"28\"><font face=\"Arial\" style=\"font-size: 12px;\"><b>&nbsp;<font color=\"#FFFFFF\" style=\"font-size: 12px;\">Event details </font></b></font></td><td width=\"50%\" height=\"24\" align=\"right\">";
	if(type=="day")
	{
		items+="<a href=\"#\" onclick=\"addevent('"+dt+"')\">";
	}
	else if(Viewtype=="weak")
	{
	...
	{
		//document.getElementById("editview").style.visibility = "hidden";
		items+="<a href=\"#\" onclick=\"getSharedEvents()\">";
	}
	else if(Viewtype=="allEvents")
	{
		items+="<a href=\"#\" onclick=\"getAllEvents()\">";
	}

	items+="<IMG SRC=\"../images/back.png\" WIDTH=\"22\" HEIGHT=\"22\" BORDER=\"0\" ALT=\"&lt;&lt;&nbsp;Back\"></a>&nbsp;</td></tr></table></center>";
