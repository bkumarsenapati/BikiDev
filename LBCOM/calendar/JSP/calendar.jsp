...
<html xmlns="http://www.w3.org/TR/xhtml1/strict">
	...
	<script type="text/javascript" src="../JS/sharedevents.js"></script> 
	...
	//	var c_page=document.getElementById("type").value;
		...
		window.location.href='addEventForm.jsp?sel_date='+dt+'&source=day';
...
{	
	...
	%>
	<Body onload="seldate('<%=request.getParameter("type")%>','<%=request.getParameter("dt")%>');hide('cal');hide('cal_next');">
	<%
	}
	}else{
	%>
	...
	<td width="3%">&nbsp;&nbsp;</td>
	<td width="14%" valign="top" align="center" height="20%">
	...
	<div width="12%" id="rtext"></div>
	 ...
	 <!--  <tr>
        ...
        <table border="1" cellpadding="0" cellspacing="0"   width="100%" id="AutoNumber1" height="100%">
          <tr>
            <td width="16%" valign="top">
            <table border="0" cellpadding="0" cellspacing="0" valign="top" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" height="100%">
              <tr>
