...
out.print("<root>");
		...
		String query="select * from event where sharing='public' and owner='"+uid+"' ";
...
catch(Exception e)
{
	...
	ExceptionsFile.postException("getSharedEvents.jsp","Unknown exception","Exception",e.getMessage());
}finally{
		try{
		if(rs!=null)
			rs.close();
	...
	ExceptionsFile.postException("getSharedEvents.jsp","Database exception","Exception",e.getMessage());
		}
}
%>
