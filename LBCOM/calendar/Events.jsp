...
<%
String teacherId="",schoolId="",teacherName="";
Connection con=null;
Statement st=null;
ResultSet rs=null;
...
try
{
	System.out.println("ffefewfefef");
	%>
...
<%				
					System.out.println("Enetered into events page");
					rs = st.executeQuery("select sdate from event where owner='"+teacherId+"'");
					while(rs.next())
					{
						i++;
