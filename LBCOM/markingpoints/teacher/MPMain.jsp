...
*/
%>
<iframe src="/LBCOM/markingpoints/teacher?courseid=<%=courseId%>&coursename=<%=courseName%>&classid=<%=classId%>&classname=<%=className%>" width="100%" height="700px" frameborder="0" scrolling="auto"></iframe>
