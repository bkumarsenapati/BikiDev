...
<TR>
			...
			<TD align="center">
				<b>:</b></TD>
			<TD>
				<font face="Arial" size="2"><input type="checkbox" name="imp" value="0" title="Important"></font>
			</TD>
...
<TR>
			...
			<TD align="center"><b>:</b></TD>
			<TD><font face="Arial" size="2"><input type="checkbox" name="imp" value="0" title="Important"></font></TD>
		</TR>
