...
<table  border="1" style="border:2px outset #eb473b; margin-top:-18px;" width="100%" align="left" cellspacing="2" bordercolordark="#9db38a" bordercolorlight="#9db38a" bordercolor="#9db38a" >
    <tr>
        <td width="100%" bgcolor="#9db38a" colspan="4"><font face="Arial" color="#FFFFFF"><span style="font-size:11pt;"><b><img src="/LBCOM/WhiteBoard/icons/chalk_board.png" width="24" height="24" border="0" align="absmiddle">&nbsp;Boards</b></span></font></td>
    </tr>
    <tr>
        <td bgcolor="#ffea9d" width="60%" ><center>
            <p><span style="font-size:10pt;"><font face="Arial"><b>&nbsp;<img src="/LBCOM/WhiteBoard/icons/computer.png" width="18"  border="0" align="absmiddle">&nbsp;Boards in session</b></font></span></center></p>
        </td>
        ...
        <td width="40%"  bgcolor="#ffea9d" >
            <p align="center"><font face="Arial"><span style="font-size:11pt;"><b><img src="/LBCOM/WhiteBoard/icons/she_user.png" width="18" height="18" border="0" align="absmiddle"></b></span></font><span style="font-size:10pt;"><font face="Arial"><b> Created By</b></font></span></p>
        </td>
    </tr>
 ...
 <tr>
        ...
        <!-- <td width="40%" bgcolor="#ffea9d">
			<font face="Arial" size="2">&nbsp; <%=rs.getString("webinar_id")%>  : <%=rs.getString("webinar_name")%></font></td> -->
			 <td width="60%"  bgcolor="#ffea9d"><center>&nbsp;
			<a href="#" onClick="if(confirm('Are you sure you want to join this board')){popup('<%=attdURL%><%=std_id%>');}else{ return false;}"><font face="Arial" size="2" color="green"><%=rs.getString("webinar_name")%></font></center></a>
		</td>     
        <td width="40%" bgcolor="#ffea9d"><center>
			<font face="Arial" size="2">&nbsp; <%=rs.getString("teacher_id")%></font></center></td>
      </tr>
...
{
	//$('html').fadeOut("fast").load('CheckSession.jsp?facilityid=<%=schoolId%>&wid=<%=webinarId%>&userid=<%=emailId%>').fadeIn("fast");

	$('html').toggle().load('CheckSession.jsp?facilityid=<%=schoolId%>&wid=<%=webinarId%>&userid=<%=emailId%>').toggle();

	//$('#email_but').toggle().load('SessionTimeOut.jsp').toggle();
}, 10000);
</script>
</form>
</body>
