...
<a href="/LBCOM/"><font color="#DD5800">Login Again</font></a></font></b></p>
        	</TD>
        </TR>
        </TBODY>
        </TABLE>
...
<TR>
	<TD align=middle width="646" height="24">
		<font face="Verdana">
		<span class="sheet style14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        Copyright © 2010 Learnbeyond. All Rights Reserved.</span></font></TD>
...
{
	ExceptionsFile.postException("SignOut.jsp","Operations on database","Exception",e.getMessage());
	System.out.println("Error in SignOut.jsp:  -" + e.getMessage());
}
finally
{
	try
	...
	{
		ExceptionsFile.postException("SignOut.jsp","closing statement and connection  objects","SQLException",se.getMessage());
		System.out.println("SQL Error in SignOut.jsp"+se.getMessage());
	}
}
%>
