	...
	importJs(url, function() {
			...
			if (FLVS.Sitemap.module.length >=6){
				for(var i=7; i<=12; i++){
					...
					if(i<10){
						...
						if(i<12){
							menu += '<li><a href="javascript:void(0);" data="'+FLVS.Sitemap.module[i].title+'" class="right_mod_link bottom_line"><strong>'+zero+numCount+': </strong>'+FLVS.Sitemap.module[i].title+'</a></li>';
						}
						
						//last link in the list
						else {
							menu += '<li><a href="javascript:void(0);" data="'+FLVS.Sitemap.module[i].title+'" class="right_mod_link"><strong>'+zero+numCount+': </strong>'+FLVS.Sitemap.module[i].title+'</a></li>';
						}
		...
		function createRightMenuMobile(){
			...
			for(var i=7; i<=12; i++){
				...
				if(i<12){
					menu += '<h3 class="right_mod_link bottom_line"><a class="mobile_mod" href="javascript:void(0);"><strong>'+zero+i+': </strong>'+FLVS.Sitemap.module[i].title+'</a></h3>';
				}
				
				//last link in the list
				else {
					menu += '<h3><a class="mobile_mod" href="javascript:void(0);"><strong>'+zero+i+': </strong>'+FLVS.Sitemap.module[i].title+'</a><h3>';
				}
