...
function HM_f_GetItemHtmlStr(arraystring){
	...
	TempString = "<font style=" + "'font-family:" + HM_FontFamily + ";font-size:" + HM_FontSize + "px;'" + ">" + TempString + " ";
...
function HM_f_PopMenu(e){
	...
	HM_CurrentMenu.xPos = (HM_CurrentMenu.tree.MenuLeft!=null) ? eval(HM_CurrentMenu.tree.MenuLeft) : e.pageX;
	HM_CurrentMenu.yPos = (HM_CurrentMenu.tree.MenuTop!=null)  ? eval(HM_CurrentMenu.tree.MenuTop)  : e.pageY;
