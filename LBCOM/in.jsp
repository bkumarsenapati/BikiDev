...
<!--
/* caused problems. to be fixed.
if (window.location.protocol != "https:") {
	alert("unencrypted login is insecure; use 'https' in place of 'http', if not redirected automatically.");
...
%>	        	 
	...
	<tr>
		<td colspan="8" rowspan="2" valign="top" align=center><br /><br />
			<a href="tech.html#browsers"><span style="font-size: 12pt;">[Browser Specific Requirements]</span></a>
			<br>
