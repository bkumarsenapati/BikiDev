...
<HTML>
	...
	<%
		...
		try{
			...
			bundle.delete();
			url="ShowAssessmentList.jsp?teacherid="+teacherid+"&courseid="+courseid+"&schoolid="+schoolid+"&classid="+classid+"&topicid=&subtopicid=&classname="+classname+"&coursename="+coursename;
