...
<%
	String courseName="",dispMsg="",developerId="",grade="",courseDesc="";
...
<body >
<form enctype="multipart/form-data" method="POST" name="addcourse" action="AddUploadCourse.jsp?mode=add&userid=<%=developerId%>" onsubmit="return validate();">
...
<tr class="gridhdrNew">
          ...
          <td width="313" height="30" valign="middle">
            <p align="left"><b>Upload Course</b></td>
...
<select size="1" name="subject" style="width:400px;">
					  ...
					  <td align="middle"  width="257" height="22" class="gridhdrNew1">
                        ...
                        <p>:</p></td>
						<td align="middle"  width="257" height="22" class="gridhdrNew1">
                        <p align="left"> <input type="file" name="cfile" size="20"></font></td>
                   
                    </tr>
					 <tr >
                        <td align="middle"  width="257" height="22" class="gridhdrNew1">
                        <p align="left"><font >Grade </font><font color="red">*</font></td>
                      <td align="middle"  width="13" height="22" class="gridhdrNew1">
                        <p>:</p></td>
                  <td align="middle" class="gridhdrNew1" width="444" valign="middle" height="22">
      <p align="left">
						<INPUT type="text"  name="grade" value="<%=grade%>" size="20" width="400" style="width:400px; height:20px;"></td>
                      </tr>

					   <tr >
                        <td align="middle"  width="257" height="22" class="gridhdrNew1">
                        <p align="left"><font >Course Description </font><font color="red">*</font></td>
                      <td align="middle"  width="13" height="22" class="gridhdrNew1">
                        <p>:</p></td>
                  <td align="middle" class="gridhdrNew1" width="444" valign="middle" height="22">
      <p align="left">
						<INPUT type="text"  name="cdesc" value="<%=courseDesc%>" size="20" width="400" style="width:400px; height:20px;"></td>
                      </tr>
					<tr>
