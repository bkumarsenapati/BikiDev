...
function goSub(sId)
{
	...
	$("#window_block2").load("Common_Core/StandardsMapping1.jsp?userid=<%=developerId%>&courseid=<%=courseId%>&coursename=<%=courseName%>&unitid=<%=unitId%>&lessonid=<%=lessonId%>&subjid="+sId);
...
function goUnit(cId)
{
	...
	$("#window_block2").load("Common_Core/StandardsMapping2.jsp?userid=<%=developerId%>&courseid=<%=courseId%>&coursename=<%=courseName%>&unitid=<%=unitId%>&lessonid=<%=lessonId%>&&gradeid="+unitId+"&subjid="+subjId);
...
{	alert(lId);
	...
	$("#window_block2").load("Common_Core/StandardsMapping3.jsp?userid=<%=developerId%>&courseid=<%=courseId%>&coursename=<%=courseName%>&unitid=<%=unitId%>&unitname=<%=unitName%>&lessonid=<%=lessonId%>&lessonname=<%=lessonName%>&subjid="+subjId+"&gradeid="+unitId+"&standardid="+lId);
