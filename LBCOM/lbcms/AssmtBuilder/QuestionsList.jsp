...
<%
		 ...
		 if(mode.equals("del"))
		{
			 ...
			 int d=st.executeUpdate("delete from  lbcms_dev_assmt_content_quesbody  where q_id='" +request.getParameter("qid")+"'");
			 st.close();
...
{
	document.location.href="/LBCOM/exam.AssLBCMSVariations?noofgrps=<%=noOfGrps%>&examname=<%=examName%>&examid=<%=assmtId%>&examtype=<%=examType%>&courseName=<%=courseName%>&courseid=<%=courseId%>&random1=<%=random%>&variations=<%=variations%>&sort1=<%=sort%>";
}
</script>
...
function deleteQuestion(qid,asmtid){
		if(confirm("Are you sure that you want to delete the question?")==true){		
		 ...
		 alert(qid);
		 alert(asmtid);
		 window.location.href="QuestionsList.jsp?mode=del&enableMode=null&start=0&totrecords=&start=&topicid=none&subid=none&samePage=0&visited=1&difflevel=-1&courseid=<%=courseId%>&coursename=<%=courseName%>&classid=C000&assmtId=<%=assmtId%>&userid=<%=developerId%>&view=false&qid="+qid;
		   return false;
		}
		else
			return false;
...
<table border="0" width="766" cellspacing="0" cellpadding="0"   >
  <tr>
    <td class="gridhdrNew" height="21" >
	  ...
	  <td  class="gridhdrNew" height='21' align='right' ><font face="arial" size="2">Page&nbsp;
	  <%int index=1;
	    int str=0;
	    int noOfPages=0;
...
<table width="759">
<tr>
    <td width="20" class="gridhdrNew1" height="18" align="center" valign="middle">
     <!-- <input type="checkbox" name="checkAll" onclick="return check_all();" value="ON" > --> </td>
    <td width="28" class="gridhdrNew1" height="18" align="center" valign="middle"><font size="2" face="Arial" color="#000080"><b><!-- <a href="#" onclick="return deleteAllQuestions()" > --><a href="#" onClick="alert('will be added soon!')" ><!-- <img border="0" src="images/idelete.gif"  TITLE="Delete all."> --></b></font></a></td>
   <td width="11" class="gridhdrNew1" height="18" align="center" valign="middle">&nbsp;</td>
   <td width="335" class="gridhdrNew1" height="21"><b><font size="2" face="Arial" color="#000080">Question Description</font></b></td>
   <td width="140" class="gridhdrNew1" height="21"><b><font size="2" face="Arial" color="#000080">Correct Response</font></b></td>
   <td width="86" class="gridhdrNew1"height="21"><b><font size="2" face="Arial" color="#000080">Incorrect Response</font></b></td>
   <td width="50" class="gridhdrNew1" height="21"><b><font size="2" face="Arial" color="#000080">Question Type</font></b></td>
</tr>
...
//path=path+"1.html";
%>
<font size=3 style="margin-left:150px;">Assessment Submited Sucessfully<a href="<%=path%>" target="_blank">View</a></font>
<%
}
%>
