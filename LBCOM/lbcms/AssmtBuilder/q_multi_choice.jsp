...
<% 
	String    qid,classid,courseid,topicid,subtopicid,qtype,schoolid,pathname="",edittype,sqlstring,q_body="",ans_str="",scriptvar="",assmtid="";
	String[] hint=new String[3];
	/** Added by Santhosh **/
	String difficultLevel="",pointspossible="",IncorrectResponse="";
	String timeScale="";
	...
	System.out.println("MC ....courseid"+courseid+classid+topicid+subtopicid+"q_mc...assmtid..."+assmtid);
	...
	if(qid.equals("new"))
	{
		...
		"initSpan2('l_o_area_id', 'text', 'o_2');"+"initSpan2('l_p_area_id', 'textbox', 'h_2');"+
		...
		"initSpan2('l_n_area_id', 'textbox', 'h_2');"+
		...
		try{
			...
			System.out.println("Exception in q_multi_choice.jsp is.............."+se);
		}
		finally
	{
			try
			...
			{
				System.out.println("The exception2 in q_multi_choice.jsp is................."+se.getMessage());
			}
	}
	}
