//	---------------------------------
//	type 2: multiple choice		// qtype = 0 in selection list
	  var q_2_rows=3, o_2_rows=1, h_2_rows=2, c_2_rows=2, i_2_rows=2;
	  var q_2_cols=54, o_2_cols=40, h_2_cols=30, c_2_cols=30, i_2_cols=30;
     
	  var q_2_i = 1, o_2_i = 4, h_2_i = 1, c_2_i = 1, i_2_i = 1;
//	---------------------------------
if (navigator.appVersion.indexOf("Win")!=-1){
  if(document.all){
	q_2_cols=64; o_2_rows=2;}
  else
	q_2_cols=50;
}
...
//msg['default'] = '<b>>>>> Question type: Multiple choice.</b><br>' +
msg['default'] = '<b>>>>> </b>' +
		msg['common'];

	function write_review2() {
...
addtextarea(t_fr,"qo_form_id","d_ta_id","d_ta","hidden","80","20","virtual");// added by Santhosh
...
/****      added by Santhosh *****/
////alert('cn is asdfasd '+cn+' diff '+document.getElementById('l_d_area_id').childNodes[cn].options[0].value);
...
fb_incorrect_str = "\n@@BeginIBody\n" + fb_incorrect_str + "\n@@EndIBody";
      ...
      function initSpan2(v_id, t, s){
        var j, k, rw, cl;

        switch (s) {
            case 'q_2'  : j = q_2_i; break;
            case 'o_2'  : j = o_2_i; toggle('l_o_arr'); break;
            case 'h_2'  : j = h_2_i; break;
            case 'c_2'  : j = c_2_i; break;
            case 'i_2'  : j = i_2_i; break;
            default     : j = q_2_i;
        }
	...
	function initBox2(s_id, n, t, s, str) {
		...
		/**  By Santhosh **/
		switch (s) {
			case 'q_2'	: rw = q_2_rows; cl = q_2_cols; break;
			case 'o_2'	: rw = o_2_rows; cl = o_2_cols; break;
			case 'h_2'	: rw = h_2_rows; cl = h_2_cols; break;
			case 'c_2'	: rw = c_2_rows; cl = c_2_cols; break;
			case 'i_2'	: rw = i_2_rows; cl = i_2_cols; break;
			default		: rw = q_2_rows; cl = q_2_cols;
		}
	...
	/**  By Santhosh **/
		  case "textbox" :
			  ...
			  if (arr != '')
				...
				break;
    	  case "select" :
			  //alert(s_id+","+id1+","+v1+","+cls+","+optionnames+","+optionvalues+","+str+","+defaultval);
