...
%>
					...
					<%=alt%><table colspan="2"><tr> <td  style="padding-right:200px; padding-left:5px;width:250px; overflow:hidden;"><input align="left" type="checkbox" name="languages" value="<%=rs.getString("course_id")%>"> <%=rs.getString("course_name")%></tr></table>
...
<%
				...
				st.close();
%>
 <br/><input type="button" class="button"  name="goto" onClick="selectCheckBox()" value="Search">
        </div>
</div>
