...
<% 
	...
	qtype="7";//request.getParameter("qtype");
	...
	edittype="self.focus();"+
			...
			"pathname='"+pathname+"';";
	if(qid.equals("new"))
		edittype=edittype+"help('default');init_temp(1,7);"+
		"if (INIT_TEMP) {"+
		"initSpan7('l_q_area_id', 'text', 'q_7');"+
		"initSpan7('l_o1_area_id', 'text', 'o_7');"+"initSpan7('l_p_area_id', 'textbox', 'h_7');"+
		"initSpan7('l_n_area_id', 'textbox', 'h_7');"+
		"initSpan7('l_o2_area_id', 'text', 'o_7');"+
		"initSpan7('l_d_area_id', 'select', 'h_7');"+  		/** Added by ramesh **/
		"initSpan7('l_e_area_id', 'textbox', 'h_7');"+  	/** Added by ramesh **/
		"initSpan7('l_s_area_id', 'select', 'h_7');"+		/** Added by ramesh **/
		"initSpan7('l_h_area_id', 'text', 'h_7');"+
		"initSpan7('l_c_area_id', 'text', 'h_7');"+
		"initSpan7('l_i_area_id', 'text', 'h_7');"+
		"chgFocus('l_q_ta0_id');"+
		"}";
		...
		try{
			...
			if(rs.next()){
				...
				temp="var pparam='"+pointspossible+"'; var nparam='"+IncorrectResponse+"';addToSpan('l_p_area_id','textbox','h_2',pparam);addToSpan('l_n_area_id','textbox','h_2',nparam);addToSpan('l_d_area_id','select','h_2',dparam);addToSpan('l_e_area_id','textbox','h_2',eparam);addToSpan('l_s_area_id','select','h_2',sparam);";
				/** Added by ramesh **/
			}
			con.close();
			Parser p=new Parser();
			...
			edittype=edittype+temp+"s_ans='"+ans_str+"';write_review7();chgFocus('l_q_ta0_id');";
...
<html>
  <head>
	...
	*{
    ...
    <script type="text/javascript" src="q_order.js"></script>
...
<hr>
<span class="q_title">Ordering Type</span>
<br><hr>
</td></tr>
...
-->
		 ...
		 <div id="l_mb_o_id" class="l_mb_o">
		   <div class="f_left">
           <input class="m_o_buttons" type="image" src="images/text.gif" title="[text]" 
				onMouseOver="help('addOptions');"
				onMouseOut="help('default');"
		   		onClick="addToSpan('l_o2_area_id','text','o_7',''); 
                         addToSpan('l_o1_area_id','text','o_7','');
				return false;"/>
		   </div>
		 </div>
		 <div id="l_o_area_id" class="l_o_area" >
		   <table border="0">
			 <tr vAlign="top">
                  		<td>
		   		<div id="l_o1_area_id" class="f_left" style="width:180">
		   		</div>
                  		</td>
                  		<td>
		   		<div id="l_o2_area_id" class="f_left" style=" visibility:hidden">
		   		</div>
                  		</td>
			</tr>
		  </table>
		 </div>
		 <div id="l_b_area_id" class="l_b_area" style="height:180">
		   <table border="0">
		   <!-- ************** Added by Ramesh ****************-->
		   <tr>
		   ...
		   <div id="l_d_area_id" class="f_left">
			...
			<tr>
                  ...
                  <td>
					 <div id="l_e_area_id" class="f_left"></div><div id="l_s_area_id" class="f_left"></div>
                  </td>
...
<div id="r_qo_top_id" class="f_left"><img src="images/r.gif"></div>
         <div id="r_mb_qo_id" class="r_mb_qo">
		   ...
		   <input id="b_review" class="t_buttons"
		   		...
		   		onClick="write_review7('q_area_id', 'o_area_id');
//				document.getElementById('b_review').focus();
		 ...
		 <div id="r_qo_area_id" class="r_qo_area" style="height: 360px"> </div>
