...
<%
	String qid="",classid="",courseid="",topicid="",subtopicid="",qtype="",urlattach="",pathname="",edittype="",assmtId="";
%>
<%
...
System.out.println("courseid"+courseid+classid+topicid+subtopicid+assmtId+"fetch");	urlattach="?qid="+qid+"&classid="+classid+"&assmtId="+assmtId+"&courseid="+courseid+"&topicid="+topicid+"&subtopicid="+subtopicid+"&qtype="+qtype+"&pathname="+pathname+"";
