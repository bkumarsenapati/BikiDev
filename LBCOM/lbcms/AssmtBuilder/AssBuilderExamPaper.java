...
public class AssBuilderExamPaper 
{
	DbBean db;
	Connection con;
	Statement st;
	...
	public void setPaper(Hashtable verns,String examId,int nQtns,String teacherId,String qtnTbl,String schoolId,String courseId,String courseName,String schoolPath,int importFlag)
	{
		try
		{
			System.out.println("Entered into exampaper");
			this.qtnTbl=qtnTbl;
			System.out.println("Entered into exampaper..."+qtnTbl);
			...
			else
			{
				...
				examTblName="dev_assessment_master";
				//grpTblName=schoolId+"_"+examId+"_group_tbl_tmp";
			}
			System.out.println("examTblName..."+examTblName);
			...
			if(rs.next()) 
			{
				...
				System.out.println("noOfGrps..."+noOfGrps);
			...
			if(noOfGrps>0)
			{
				System.out.println("if ...noOfGrps...greater.."+noOfGrps);
...
//RAJESH
		...
		{
			ExceptionsFile.postException("AssBuilderExamPaper.java","setPaper","Exception",e.getMessage());
		}
		finally
		{
			try
			...
			{
				ExceptionsFile.postException("AssBuilderExamPaper.java","closing connections","SQLException",se.getMessage());
            }
		}
	}
	...
	private void constructPaper(Hashtable versns)
	{
		...
		if (importFlag==1)
		{
			...
			System.out.println("dPath is  1...if.."+dPath);
		}
		else
		{
			dPath= schoolPath+"/"+courseId+"/"+examId;
			System.out.println("dPath is  2..else...."+dPath);
		}
	...
	private void crtExmTopPanel(String exmPath)
	{
		try
		{
			...
			fString=fString+"<tr><td colspan='7'  valign='middle' align='left'><font face='Arial'><span style='font-size:10pt;'>&nbsp;*&nbsp;A checkbox is provided on the left of every question serial number to control the answer submission. ( <img src='/BUNDLE/images/checked.jpg' width='18' height='18' border='0'>Submit <img src='/BUNDLE/images/unchecked.jpg' width='18' height='18' border='0'> \n";
...
//		exTPFile.close();
	...
	private void crtExmMidPanel(String qIds,String vNo,String exmPath)
	{
		...
		try
		{
			...
			oText=oText+"<script language='javascript' src='/BUNDLE/validationscripts.js'></script>\n";
			oText=oText+"<script language='javascript' src='/BUNDLE/common/evaluation.js'></script>\n";
			oText=oText+" </head>\n";
			oText=oText+"<body oncontextmenu='return false;' link='#FFFFFF' alink='#FFFFFF' vlink='#FFFFFF' leftmargin=0 topmargin=0>\n";
			oText=oText+"<form name='q_paper' enctype='multipart/form-data' action='/BUNDLE/exam/SubmitShtAnsFiles.jsp?examid="+examId+"' method='post'>\n";
			...
			{								
				...
				if(qType==3)
				{
					fText=QuestionFormat.getFormattedQnBdyForFB(fText,qId,qNoStr)+"</table><br>";
...
//		fStr=fStr+"	var qTypes=parent.mid_f.qType;\n";
		...
		if (selfTest==false){		
			fStr=fStr+"<body leftmargin='0' oncontextmenu='return false;'><form name='bpanel' method='POST' action='/BUNDLE/exam.ProcessResponse'>\n";
		}else{
			fStr=fStr+"<body leftmargin='0' oncontextmenu='return false;'><form name='bpanel' method='POST' action='/BUNDLE/exam.SelfTestProcessing'>\n";
		}
		...
		fStr=fStr+"<input type='image' src='/BUNDLE/images/std_status.gif' name='status' onclick='c_status();return false;'></font></td><td width='7%'>&nbsp;</td>\n";
		fStr=fStr+"<td width='49%'><p align='right'><font face='Arial' size='2'>\n";
		fStr=fStr+"<input type='image' src='/BUNDLE/images/std_submit.gif' name='submit' onclick=\"go(false,'','',false);return false;\"></font></td></tr></table></form></body>\n";
		fStr=fStr+"</html>\n";
	 ...
	 public void beginAnsHtml(String path){
		...
		try{
			...
			str=str+"<title></title>"+"\n";
			str=str+"<script language='javascript' src='/BUNDLE/validationscripts.js'></script>"+"\n";
			str=str+"<script language='javascript' src='/BUNDLE/common/evaluation.js'></script>"+"\n";
   ...
   private void endAnsHtml(String path) {
		...
		*/
		...
		//str=str+"	<a href='#' onclick=\"parent.btm_f.location.href='/BUNDLE/exam/CheckExamStatus.jsp?examid="+examId+"&createddate="+createdDate.replace('-','_')+"&version="+version+"&stupassword="+stuPassword+"'\">Do you want to submit again</a>"+"\n";
		str=str+"</body>"+"\n";
		str=str+"</html>"+"\n";
		writeInToFile(rFile,str);
   ...
   private void endAnsHtml(String path,String examId,String createdDate,int version,String stuPassword) {
	   ...
	   try{
		...
		str=str+"	<a href='#' onclick=\"parent.btm_f.location.href='/LBRT/exam/CheckExamStatus.jsp?examid="+examId+"&createddate="+createdDate.replace('-','_')+"&version="+version+"&stupassword="+stuPassword+"'\">Do you want to submit again?</a>"+"\n";
		str=str+"</body>"+"\n";
		str=str+"</html>"+"\n";
		writeInToFile(rFile,str);
	   }catch(Exception e) {
