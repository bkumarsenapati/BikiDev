...
<%
	...
	qtype="4";//request.getParameter("qtype");
	...
	edittype="self.focus();"+
			...
			"pathname='"+pathname+"';";
	if(qid.equals("new"))
		edittype=edittype+"help(\'default');init_temp(1, 4);"+
		"if (INIT_TEMP) {"+
		"initSpan4('l_q_area_id', 'text', 'q_4');"+
		"initSpan4('l_o_area_id', 'text', 'o_4');"+"initSpan4('l_p_area_id', 'textbox', 'h_4');"+
		"initSpan4('l_n_area_id', 'textbox', 'h_4');"+
		"initSpan4('l_d_area_id', 'select', 'h_4');"+  		/** Added by ramesh **/
		"initSpan4('l_e_area_id', 'textbox', 'h_4');"+  	/** Added by ramesh **/
		"initSpan4('l_s_area_id', 'select', 'h_4');"+		/** Added by ramesh **/
		"initSpan4('l_h_area_id', 'text', 'h_4');"+
		"initSpan4('l_c_area_id', 'text', 'h_4');"+
		"initSpan4('l_i_area_id', 'text', 'h_4');"+
		"chgFocus('l_q_ta0_id');"+
		"}";
	else{
		try{
			...
			edittype=edittype+temp+"s_ans='"+ans_str+"';write_review4();chgFocus('l_q_ta0_id');";
		}catch(Exception se){
...
<html>
  <head>
	...
	*{
    ...
    <script type="text/javascript" src="q_short_essay.js"></script>
...
<hr>
<span class="q_title">Short answer/Essay Type</span>
<br><hr>     
</td></tr>
...
-->
         ...
         <div id="l_mb_o_id" class="l_mb_o">
           <div class="f_left">
           <img src="images/text.gif" title="[text]"
                onMouseOver="help('hint');"
                onMouseOut="help('default');">
           </div>
           <div class="hide">
		 ...
		 <div id="l_o_area_id" class="l_o_area" style="height:100px">
		 </div>
...
<div id="r_qo_top_id" class="f_left"><img src="images/r.gif"></div>
		 <div id="r_mb_qo_id" class="r_mb_qo">
		   ...
		   <input id="b_review" class="t_buttons"
		   		...
		   		onClick="write_review4('q_area_id', 'o_area_id');
//				document.getElementById('b_review').focus();
		...
		<div id="r_help_id" class="r_help"> </div>
		 ...
		 <div id="r_sub_stat" class="f_left" style="width: 400px; 
		 	height: 175px; overflow: auto"></div>
		</td>
	  </tr>
	</table>
   </td>
