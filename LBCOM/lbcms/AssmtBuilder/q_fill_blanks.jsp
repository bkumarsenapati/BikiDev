...
<% 
	...
	qtype="5";//request.getParameter("qtype");
	...
	edittype="self.focus();"+
			...
			"pathname='"+pathname+"';";
	if(qid.equals("new"))
		edittype=edittype+"help('default');init_temp(1, 5);"+
		"if (INIT_TEMP) {"+
		"initSpan5('l_q_area_id', 'text', 'q_5');"+
		"initSpan5('l_o_area_id', 'text', 'o_5');"+"initSpan5('l_p_area_id', 'textbox', 'h_5');"+
		"initSpan5('l_n_area_id', 'textbox', 'h_5');"+
		"initSpan5('l_d_area_id', 'select', 'h_5');"+
		"initSpan5('l_e_area_id', 'textbox', 'h_5');"+
		"initSpan5('l_s_area_id', 'select', 'h_5');"+
		"initSpan5('l_h_area_id', 'text', 'h_5');"+
		"initSpan5('l_c_area_id', 'text', 'h_5');"+
		"initSpan5('l_i_area_id', 'text', 'h_5');"+
		"chgFocus('l_q_ta0_id');"+
		"}";
	else{
		try{
			...
			edittype=edittype+temp+"s_ans='"+ans_str+"';write_review5();chgFocus('l_q_ta0_id');";
...
<html>
  <head>
	...
	*{
    ...
    <script type="text/javascript" src="q_fill_blanks.js"></script>
...
<hr>
<span class="q_title">Fill-in-the-blanks Type</span>
<br><hr>
</td></tr>
...
<div id="l_q_top_id" class="f_left"><img src="images/l.gif"></div>
		<div id="l_mb_q_id" class="l_mb_q">
		 ...
		 <div id="l_mb_o_id" class="l_mb_o">
		   <div class="f_left">
           <input class="m_o_buttons" type="image" src="images/word.gif" title="[word]" 
				onMouseOver="help('word');"
				onMouseOut="help('default');"
		   		onClick="addToSpan('l_o_area_id','text','o_5','');
				return false;"/>
		   </div>
		   <div class="hide">
		 ...
		 <div id="l_o_area_id" class="l_o_area" style="height:95">
		 </div>
...
<div id="r_qo_top_id" class="f_left"><img src="images/r.gif"></div>
         <div id="r_mb_qo_id" class="r_mb_qo">
		   ...
		   <input id="b_review" class="t_buttons"
		   		...
		   		onClick="write_review5('q_area_id', 'o_area_id');
//				document.getElementById('b_review').focus();
         ...
         <div id="r_f_area_id" class="r_qo_area" style="height: 19px"> </div>
