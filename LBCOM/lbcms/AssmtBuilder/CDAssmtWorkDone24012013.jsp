...
<div align="center">
  ...
  <table border="0" cellspacing="0" width="80%" id="AutoNumber2" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0">
    <tr>
      ...
      <img border="0" src="images/hscoursebuilder.gif" width="194" height="40"></td>
...
<div align="center">
  ...
  <table border="1" cellspacing="1" width="80%" id="AutoNumber1" bordercolor="#111111" height="1">
    ...
    <tr>
      ...
      <td width="61%" height="1" bgcolor="#EBEBEB"><%=categoryName%>
	  </td>
    </tr>
	...
	%>
	<tr>
<td width="53%" colspan="2" height="8" align="center">
...
<option value="6">Short/Essay-type</option>
	...
	<tr>
		<td width="73%" colspan="2" height="41" align="center">
