...
<%
	...
	{	 
		...
		{
			masterTable="lbcms_dev_assgn_social_larts_content_master";
		...
		{
			masterTable="lbcms_dev_assgn_science_content_master";
		
		}
		else
		{
			masterTable="lbcms_dev_assgn_math_content_master";
		}
		...
		for(Enumeration e1 = workIds.elements() ; e1.hasMoreElements() ;)
		{
			...
			if(rs1.next())
			{
				...
				i=st.executeUpdate("update "+masterTable+" set unit_id='"+unitId+"',lesson_id='"+lessonId+"',lesson_name='"+lessonName+"' where slno="+wId+" and course_id='"+courseId+"'");
			}
...
<table border="1" cellspacing="0" width="500" align="center">
    <tr>
      ...
      <font face="Verdana" size="2" color="#003399">&nbsp;Assignments Mapping Successfully done!</font></b></td>
    </tr>
    ...
    <tr>
      <td width="64%" colspan="2" align="center" rowspan="2" height="34">
		...
		<% 
			...
			{
%>
				<font face="Verdana" size="2"><a href="ViewAssignInfo.jsp?mode=none&courseid=<%=courseId%>&coursename=<%=courseName%>&userid=<%=userId%>">BACK TO ASSIGNMENTS LIST</a></font>
				
<%			}
			else
			{
				%><font face="Verdana" size="2">Assignments Mapping Failed!</font>
<%
			}
