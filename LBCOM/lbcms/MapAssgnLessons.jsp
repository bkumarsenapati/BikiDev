...
function goUnit(cId)
{
	...
	window.location.href="MapAssgnLessons.jsp?courseid="+cId+"&unitid="+unitId+"&assmtids=<%=assmtIds%>&userid=<%=userId%>";
}
...
{	
	...
	else
	{
		...
		window.location.href="LessonAssgnMapUpdate.jsp?assmtids=<%=assmtIds%>&courseid="+cId+"&unitid="+unitId+"&lessonid="+lessonId+"&userid=<%=userId%>";
		return true;
	}
