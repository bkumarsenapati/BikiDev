...
<%
		System.out.println("fPath11111111111111111111111..."+fPath);
...
<script language='javascript'>
	...
	window.location.href="/LBCOM/lbcms/WelcomeCourseFile.jsp?courseid=<%=workId%>&foldername=<%=folderName%>&docname=<%=docName%>&cat=<%=categoryId%>";
