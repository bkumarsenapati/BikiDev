...
<%
	...
	{	
		...
		st.executeUpdate("update lbcms_dev_lessons_master set ltoday='none',critical_questions='"+questions+"',materials_i_need='"+materials+"' where course_id='"+courseId+"' and unit_id='"+unitId+"' and lesson_id='"+lessonId+"'");
