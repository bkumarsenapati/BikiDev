...
<%
			int j=0;
			rs=st.executeQuery("select * from lbcms_dev_units_master where course_id='"+cbCourseId+"' order by unit_id");
			while(rs.next())
			{
			unitId=rs.getString("unit_id");
			unitName=rs.getString("unit_name");
			j=0;
			//rs3=st3.executeQuery("select * from lbcms_dev_lessons_master where course_id='"+courseId+"'");
			rs3=st3.executeQuery("select * from lbcms_dev_lessons_master where course_id='"+cbCourseId+"' and unit_id='"+unitId+"' order by lesson_id");
			while(rs3.next())
			{
