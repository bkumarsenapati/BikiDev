...
<%
    ...
    Vector delcourses = (Vector)session.getAttribute("ignored_courses");
    Vector delwebinars = (Vector)session.getAttribute("ignored_webinars");
...
function applyCode()
{
	...
	window.location.href="InvoiceAfterDelete.jsp?codeflag=true&pcode="+pcode;	
}
...
<p>&nbsp;</p>
<table border="0" bordercolor="#C0C0C0" width="742" bordercolorlight="#C0C0C0" cellspacing="1" style="border-collapse: collapse">
<tr>
    <td  align="left"  height="16" colspan=2 width="738">
    <b><font face="Verdana" size="2" color="#800000">You have subscribed to the following Courses/K-Caps already.</font></b></td>
</tr>
<%
     if (delcourses != null && (delcourses.size() > 0)) {
%>
<tr>
    <td align="left"  height="16" width="557" colspan="2">
    <b><font face="Verdana" size="2" color="#800000">Ignored Courses:</font></b></td>
</tr>
<%
   for (int index=0; index < delcourses.size();index++) {
   cname = (String) delcourses.elementAt(index);
%>
  <tr>
    <td width="79" height="19" align="left"></td>
    <td width="608" height="19" align="left"><font face="Verdana" size="2" ><%= cname%></font></td>
 </tr>
<%
      }
    }
   if (delwebinars != null && (delwebinars.size() > 0)) {
%>
<tr>
    <td width="557" align="left"  height="16" colspan="2">
    <b><font face="Verdana" size="2" color="#800000">Ignored K-Caps:</font></b></td>
</tr>
<%
   for (int index=0; index < delwebinars.size();index++) {
   wname = (String) delwebinars.elementAt(index);
%>
  <tr>
    <td width="20" height="19" align="left"></td>
    <td width="608" height="19" align="left"><font face="Verdana" size="2" ><%= wname%></font></td>
 </tr>
<%
      }
    }
...
%>
		...
		<tr>
			<td width="209"><font face="verdana" size="2">Enter promotion code here:</font></td>
			<td width="532">
...
<p>&nbsp;</p>
                          ...
                          <table width="761" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <td width="13" bgcolor="#FFFFFF"><img src="lb_images/bullet.jpg" width="13" height="12" /></td>
                              <td width="106" bgcolor="#FFFFFF" class="sheet"><a href="../PrivacyPolicy.html">Privacy Policy</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="lb_images/bullet.jpg" width="13" height="12" /></td>
