...
<script type="text/javascript">
	$(document).ready(function() {
		$("#submit").click(function(){
		  ...
		  $.ajax({ 
				type: "POST",
				url: "/LBCOM/nboards.UploadNoticeFile",
				data:"mode=add",
				cache: false,
...
<body bgcolor="#FFFFFF">
<form name="fs" id="fs" method="POST" enctype="multipart/form-data"  action="/LBCOM/nboards.UploadNoticeFile?dir=<%=dirName%>&mode=<%=mode%>&notice=<%=noticeId%>&creator=<%=viewer%>" onSubmit="return checkfld('<%=mode%>');">
...
<TR>
	<TD bgcolor='<%=bgClr%>' align='center' colspan='3'>
		<input type="submit" value="Submit" name="sbmt" id="sbmt"></TD>
</TR>
</TABLE>
</center>
</form>
