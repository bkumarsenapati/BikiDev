...
<script type="text/javascript" src="jquery-1.4.4.min.js"></script>
	...
	$(document).ready(function() {
		$("#delete").click(function(){
			...
			alert(IDS);
			$nids=IDS;
			alert("Notice ids..."+$nids);
			//
			$.post("/LBCOM/nboards.DeleteNotice", {filenames:$cityName}, function(data) {
				alert(data);
...
//-->
 ...
 <div class="formdetails" id="grid_content">
<form name="f1">
<center>
<%
		if(viewer.equals("admin"))
...
%>
	<tr>
		<td colspan='6' align='left'>
			<font face="arial" size=2><a href="javascript://" onclick="return newfile();">Create New</a></td>
	</tr>
<%
	}
%>
...
%>
		...
		<tr>
			<td colspan='5' align='center'>
				<input type="button" name="delete" value="Delete" onClick="javascript:count();" style="color:black; background-color: <%=bgClr2%>; border-style: solid; border-color: <%=bgClr1%>">
				<input type="button" name="check" value="CheckAll" onClick="checkall()" style="color:black; background-color: <%=bgClr2%>; border-style: solid; border-color: <%=bgClr1%>">
				<input type="button" name="uncheck" value="ClearAll" onClick="uncheckall()" style="color:black; background-color: <%=bgClr2%>; border-style: solid; border-color: <%=bgClr1%>">			</td>
		</tr>
<%
	}
%>
