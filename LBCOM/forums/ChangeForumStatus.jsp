...
<body onload="RedirectWithDelay();"><br><center><b><i><font face="Arial" size="2" align="center">Forum Status Changed Successfully</font></i></b></center></body>
<form name=show>
<%
	Connection con=null;
	...
	String fId="",emailid="",schoolId="",fStatus="",tStatus="",uType="";
	int i=0,j=0;
%>
<%
	try
	{
		...
		j=st1.executeUpdate("update forum_post_topic_reply set status='"+tStatus+"' where forum_id='"+fId+"' and school_id='"+schoolId+"'");
		...
		if(uType.equals("teacher"))
						uType="teacher";
		out.println("<script language=\"JavaScript\">function Redirect(){	document.location.href='/LBCOM/"+uType+"Admin/ForumMgmtIndex.jsp?schoolid="+schoolId+"&emailid="+emailid+"';}");
