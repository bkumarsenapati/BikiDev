...
try{
	...
	message = request.getParameter("message");
	System.out.println("message.....in sent..:"+message);
	...
	//fout.write("<font face='arial' size='3pt' color='#4B0082'><pre>");
	fout.write(message);
	//fout.write("</pre></font>");
	...
	{     
		  ...
		  String copyBodyUrl = attachPath + "/" + sid.trim() + "/" + uid.trim() + "/email";
	      ...
	      if(len>0)
	      {	  
		  String copyUrl = attachPath + "/" + sid.trim() + "/" + uid.trim() + "/attachments/" + emailId;
		  ...
		  for(int i=0;i<len;i++)  
	    	...
	    	size = 500*allMail;    
	    	size += recursiveSizecount(attachPath + "/" + sid.trim() + "/" + uid.trim() + "/attachments");
	    	size += recursiveSizecount(attachPath + "/" + sid.trim() + "/" + uid.trim() + "/email");
	    	size /=1048576;
...
<form name="composeform" action="Sent.jsp" method="post">
 <table  width="770" height="185">
	   ...
	   <td width="202" height="57"></td>
	    ...
	    <td width="536" height="70"><b><font face="Verdana" size="2"><a href="Compose.jsp">
        <font color="#E25F38">Compose another message</font></a></font></b></td>
	    <td width="202" height="70">&nbsp;</td>
	</tr>        
  </table>
