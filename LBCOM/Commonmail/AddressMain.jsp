...
<%
        String userId="",schoolId="",queryString="",toGroup="",toSchool="",toUser="",userType="",corcId="";	
 ...
 try{
	    ...
	    st=con.createStatement();
		 System.out.println("========Address Main ============"+userType);
	    
            rs=st.executeQuery("select to_group from mail_priv where from_school='"+schoolId+"' and from_user='"+userType+"'");
            if(rs.next())
	    {
    ...
    {     System.out.println("****teacher*******");
		  ...
		  if((toGroup!=null)&&((toGroup.equals("ownclass"))||(toGroup.equals("allclass"))))
      	  {
                if(userType.equals("student"))
				{
					rs=st.executeQuery("select username, firstname, lastname from teachprofile where username=any(select teacher_id from coursewareinfo where class_id='"+corcId+"' and school_id='"+toSchool+"') and schoolid='"+toSchool+"'");
		...
		while(rs.next())
		{
           ...
           }else if((toGroup!=null)&&((toGroup.equals("owncourse"))||(toGroup.equals("allcourse"))))
	   {
    ...
    }else if((toUser!=null)&&(toUser.equals("student")))
    {
	   ...
	   {
		   System.out.println("owncourse    allcourse");
...
<table border="0" cellspacing="1" width="100%" id="AutoNumber1" height="41" bordercolorlight="#FFFFFF">
  <tr>
    ...
    <td width="47%" bgcolor="#EBEADB" height="18"><font face="verdana" size="1">&nbsp;<b>User Id</b></font></td>
    <td width="48%" bgcolor="#EBEADB" height="18"><font face="verdana" size="1">&nbsp;<b>User Name</b></font></td>
  </tr>
  <tr>
           <td></td>
...
%>	   
  	<tr>
    	   ...
    	   <td height='19' bgcolor='#F7F7F7'><font face="verdana" size="1">&nbsp;<%=id%></font></td>
           <td height='19' bgcolor='#F7F7F7'><font face="verdana" size="1">&nbsp;<%=userTable.get(id)%></font></td>
	</tr>
