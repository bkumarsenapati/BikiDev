...
%>
									  ...
									  <table width="173" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td width="165" valign="top" bgcolor="#FFFFFF"><table width="171" border="0" cellspacing="0" cellpadding="0">
											...
											%>
												<label><span class="sheet">&nbsp;&nbsp;<font color="#FF6600"><b>Password</b></font> </span> &nbsp;&nbsp;
                                                      <input type="password" name="password" size="20" value="<%=myCookiePass.getValue()%>" />
                                                    </label>
											<%
											}

											%>
											<label><span class="sheet">&nbsp;&nbsp;<font size="0"><input type="checkbox" name="selbox" title="checkbox" checked="true"><b>Remember me on this<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;computer</b></font> </span> &nbsp;&nbsp;
                                                     </label>
                                                </td>
												</tr>
											  <tr>
                      ...
                      <tr>
                        ...
                        <tr>
                            ...
                            <span class="sheet style10"><%@ include file="news/HomeNews.jsp" %></span></div></td>
                          </tr>
                        </table></td>
