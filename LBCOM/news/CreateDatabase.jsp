...
<%	
	...
	st.executeUpdate("CREATE TABLE boardinitiator(school_id varchar(50) NOT NULL default '',user_id varchar(50) NOT NULL default '',course_id varchar(15) NOT NULL default '',course_name varchar(100) NOT NULL default '',board_start datetime default NULL,board_end datetime default NULL,user_type varchar(20) default NULL)");
