...
%>
  ...
  <tr>
    ...
    <td width="82%">
    	...
    	<a href="/LBCOM/news/News.jsp#news<%=newsId%>"><%=title%></a></font>
    </td>
    <td width="2%"></td>
  </tr>
...
%>
  ...
  <tr>
    <td width="16%">&nbsp;</td>
    <td width="82%">
    <p align="right"><font face="Verdana" size="1"><a href="/LBCOM/news/News.jsp">More&gt;&gt;</a></font></td>
    <td width="3%">&nbsp;</td>
  </tr>
</table>
</body>
...
<%
	...
	{
		System.out.println("The exception in SignOutNews.jsp is..."+e);
	}
%>
