...
<%	
	...
	try
	{
		...
		rs=st.executeQuery("select bm.teacher_id,em.webinar_name,bm.att_url,bm.webinar_id from bbb_master bm inner join eclassmaster em on bm.webinar_id=em.webinar_id and bm.school_id=em.school_id where bm.school_id='"+schoolId+"' and bm.webinar_id='"+webinarId+"' and bm.start_date<=curdate()");
