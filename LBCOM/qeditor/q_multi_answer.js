//	---------------------------------
//	type 1: multiple answers	// qtype = 1 in selection list
	  var q_1_rows=3, o_1_rows=1, h_1_rows=2, c_1_rows=2, i_1_rows=2;
	  var q_1_cols=54, o_1_cols=40, h_1_cols=30, c_1_cols=30, i_1_cols=30;

	  var q_1_i = 1, o_1_i = 4, h_1_i = 1, c_1_i = 1, i_1_i = 1;
//	---------------------------------
if (navigator.appVersion.indexOf("Win")!=-1){
  if(document.all){
	q_1_cols=64; o_1_rows=2;}
  else
	q_1_cols=50;
}
//	---------------------------------
...
//msg['default'] = '<b>>>>> Question type: Multiple answers.</b><br>' +
msg['default'] = '<b>>>>> </b>' +
		msg['common'];

	function write_review1() {
	  if (HAMode) {alert("Please exit HTML editor."); return false;}
		...
		var show_buttons = 0;
//		b = document.getElementById("r_b_refresh_id");
...
addnewform(t_fr, "qo_form_id", "qo_form", "post", "", "1");
addtextarea(t_fr,"qo_form_id", "qo_ta_id","qo_ta","hidden","60","20","virtual");
addtextarea(t_fr,"qo_form_id", "a_ta_id","a_ta","hidden","60","20","virtual");
...
addRow("r_o_t_id", rid, "r_or_d");
			...
			addInputElem("r_qo_area_id", kcbi, "kcb_o"+i, "checkbox", "", "");
...
//alert('cn in multi-answer is '+cn+' diff '+document.getElementById('l_d_area_id').childNodes[cn].id);
...
fb_incorrect_str = "\n@@BeginIBody\n" + fb_incorrect_str + "\n@@EndIBody";
		...
		if (show_buttons > 0) {
//		  document.getElementById("r_b_refresh_id").style.visibility="visible";
		  hs_submit(0,1);
		  hs_submit(1,1);
		} else {
		  if (!INIT_TEMP) {
//		    document.getElementById("b_review").style.visibility="hidden";
			  hs_submit(0,0);
			  hs_submit(1,0);
		  }
		}
      ...
      function initSpan1(v_id, t, s){
        var j, k, rw, cl;

        switch (s) {
            case 'q_1'  : j = q_1_i; break;
            case 'o_1'  : j = o_1_i; toggle('l_o_arr'); break;
            case 'h_1'  : j = h_1_i; break;
            case 'c_1'  : j = c_1_i; break;
            case 'i_1'  : j = i_1_i; break;
            default     : j = q_1_i;
        }
	...
	function initBox1(s_id, n, t, s, str) {
		var arr='', enm;
		/**  By Ramesh **/
		...
		var rw, cl;
		switch (s) {
			case 'q_1'	: rw = q_1_rows; cl = q_1_cols; break;
			case 'o_1'	: rw = o_1_rows; cl = o_1_cols; break;
			case 'h_1'	: rw = h_1_rows; cl = h_1_cols; break;
			case 'c_1'	: rw = c_1_rows; cl = c_1_cols; break;
			case 'i_1'	: rw = i_1_rows; cl = i_1_cols; break;
			default		: rw = q_1_rows; cl = q_1_cols;
		}
