//	---------------------------------
//	type 6: matching	// qtype = 4 in selection list
	  var q_6_rows=3, o_6_rows=1, h_6_rows=2, c_6_rows=2, i_6_rows=2;
	  var q_6_cols=54, o_6_cols=28, h_6_cols=30, c_6_cols=30, i_6_cols=30;

	  var q_6_i = 1, o_6_i = 4, h_6_i = 1, c_6_i = 1, i_6_i = 1;
//	---------------------------------
if (navigator.appVersion.indexOf("Win")!=-1){
  if(document.all){
	q_6_cols=64; o_6_rows=2;o_6_cols=30}
 else{
		q_6_cols=50;o_6_cols=21;
	}
}
//	---------------------------------
var QType = 6;
...
//msg['default'] = '<b>>>>> Question type: Matching items.</b><br>' +
msg['default'] = '<b>>>>> </b>' +
		msg['common'];

	function write_review6() {
...
addCell(rid, "left", t_l, "", "1");
		out_str=out_str+ '\n' + ss + ss + ostr1;
// blank space between ss and ss is added for rng.
			}
	}
out_str=out_str+"\n@@EndQBody";
  }
		...
		j = 0;
		for (i=0; i < l_o1_no; i++) {
			var e = document.getElementById(o1_arr[i][1]);
			var f = document.getElementById(o2_arr[i][1]);
...
//addBlankCell(rid, "", "5");
addCell(rid, "right", document.createTextNode((i+1)+'. '), "5%", "1");
addCell(rid, "left", t_l, "35%", "1");
addCell(rid, "right", document.createTextNode(en["ROMAN"][i]+'. '), "5%", "1");
			t_l = document.createElement("div");
			str1_2= replaceAll(str1_2,"\n","<br>");
			t_l.innerHTML = format(str1_2);
addCell(rid, "left", t_l, "35%", "1");
addBlankCell(rid, "", "5");
addCell(rid, "right", document.createTextNode((i+1)+'.'), "5%", "1");
addCell(rid, "left", document.getElementById(sel_id_arr[i]), "10%", "1");
		}
...
fb_incorrect_str = "\n@@BeginIBody\n" + fb_incorrect_str + "\n@@EndIBody";
      ...
      function initSpan6(v_id, t, s){
        var j, k, rw, cl;

        switch (s) {
            case 'q_6'  : j = q_6_i; break;
            case 'o_6'  : j = o_6_i; break;
            case 'h_6'  : j = h_6_i; break;
            case 'c_6'  : j = c_6_i; break;
            case 'i_6'  : j = i_6_i; break;
            default     : j = q_6_i;
        }
	...
	function initBox6(s_id, n, t, s, str) {
		...
		switch (s) {
			case 'q_6'	: rw = q_6_rows; cl = q_6_cols; break;
			case 'o_6'	: rw = o_6_rows; cl = o_6_cols; break;
			case 'h_6'	: rw = h_6_rows; cl = h_6_cols; break;
			case 'c_6'	: rw = c_6_rows; cl = c_6_cols; break;
			case 'i_6'	: rw = i_6_rows; cl = i_6_cols; break;
			default		: rw = q_6_rows; cl = q_6_cols;
		}
...
//		  s_ans+=j;
		...
		s_ans = s;
//alert(en["roman"].join('').indexOf(s_ans[0]));
