...
%>
  <tr>
    <td width="43" height="243">&nbsp;</td>
    <td width="668" height="243"><b>
    <font face="Verdana" size="2" color="#008000">Welcome to Learnbeyond Payment 
    Gateway!!!</font></b><p align="justify">
    <font face="Verdana" size="2" color="#800000">Thank you for registering with 
    Learnbeyond. You have successfully registered for your desired courses. What all you have to 
    do now is, just <b><a href="#" onclick="Popup=window.open('InvoiceToPrint.jsp','Popup','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=420,height=400,left=430,top=23'); return false;"><u>print your invoice</u></a></b> , visit your school, 
    contact your school administrator for further information and get a confirmation 
    from 
    them. That's it. With in 24 hours of time, your courses</font><font color="#800000" face="Verdana" size="2"> 
    and K-Caps will be assigned to you for which you will get a confirmation 
...
%>
  <tr>
   ...
   <td width="668" height="19" align="right"><font face="Verdana" size="2"><a href="InvalidateSession.jsp">Exit From Cart</a></font> </td>
</table>
               </td>
              </tr>
              <tr>
                <td colspan="2"><table width="761" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111">
                            ...
                            <tr>
                              ...
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="112" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=pp">Privacy Policy</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="89" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=sm">Site Map</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="67" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=faq">FAQs</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
