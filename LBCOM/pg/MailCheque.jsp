...
function mmLoadMenus() {
  ...
  mm_menu_0515161022_0.addMenuItem("Courses","location='InvalidateSession.jsp?mode=pc'");
  mm_menu_0515161022_0.addMenuItem("K-Caps","location='InvalidateSession.jsp?mode=pw'");
              ...
              <tr>
                <td colspan="2"><table width="761" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="74"><a href="InvalidateSession.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image24','','images/btn_02_2.jpg',1)"><img src="images/btn_02.jpg" alt="About us" name="Image24" width="74" height="30" border="0" id="Image24" /></a><a href="/LBCOM/" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image29','','images/btn_02_2.jpg',1)"></a></td>

                    <td width="95"><a href="InvalidateSession.jsp?mode=a" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image20','','images/btn_03_2.jpg',1)"><img src="images/btn_03.jpg" alt="Aboutus" name="Image20" width="95" height="30" border="0" id="Image20" /></a><a href="/LBCOM/AboutUs.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image30','','images/btn_03_2.jpg',1)"></a></td>

                    <td width="170"><a href="InvalidateSession.jsp?mode=p" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image31','','images/btn_04_2.jpg',1)"><img src="images/btn_04.jpg" alt="Products&amp;Services" name="Image31" width="170" height="30" border="0" id="Image31" onmouseover="MM_showMenu(window.mm_menu_0515161022_0,2,32,null,'Image31');MM_showMenu(window.mm_menu_0515161022_0,2,32,null,'Image31')" onmouseout="MM_startTimeout();" /></a></td>

                    <td width="83"><a href="InvalidateSession.jsp?mode=n" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image32','','images/btn_05_2.jpg',1)"><img src="images/btn_05.jpg" alt="News" name="Image32" width="83" height="30" border="0" id="Image32" /></a></td>

                    <td width="96"><a href="InvalidateSession.jsp?mode=r" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image33','','images/btn_06_2.jpg',1)"><img src="images/btn_06.jpg" alt="Register" name="Image33" width="96" height="30" border="0" id="Image33" /></a></td>

                    <td width="99"><a href="InvalidateSession.jsp?mode=c" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image34','','images/btn_07_2.jpg',1)"><img src="images/btn_07.jpg" alt="Contact" name="Image34" width="113" height="30" border="0" id="Image34" /></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="358">
<%
   try
     {
...
%>
  <tr>
    <td width="3%" height="264">&nbsp;</td>
    <td width="95%" height="264"><b>
    <font face="Verdana" size="2" color="#008000">Welcome to Learnbeyond Payment 
    Gateway!!!</font></b><p align="justify">
    <font face="Verdana" size="2" color="#800000">Thank you for choosing to mail 
    your cheque to us. We encourage the students to send the cheque to us. In this type, there is no need to give the 
    credit card information or bank account details to us. What all you have to 
    do is, just <b><a href="#" onclick="Popup=window.open('InvoiceToPrint.jsp','Popup','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=420,height=400,left=430,top=23'); return false;"><u>print your invoice</u></a></b> ,add a cheque to it, 
    and mail it to us. That's it. You will get an acknowledgement  from us.  With in 24 hours of time, your courses and 
    K-Caps will be assigned to you for which you will get a confirmation 
    mail to the email address (<%= rs.getString("email_id") %>) which you have mentioned at your registration process.</font></p>
...
%>
  <tr>
    ...
    <td width="2%" height="19" align="right"><font face="Verdana" size="2"><a href="InvalidateSession.jsp">Exit From Cart</a></font> </td>
  </tr>
</table>
              ...
              <tr>
                <td colspan="2"><table width="761" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111">
                            ...
                            <tr>
                              ...
                              <td width="66" bgcolor="#FFFFFF"><span class="sheet"><a href="InvalidateSession.jsp">Home</a></span></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="112" bgcolor="#FFFFFF" class="sheet"><a href="#">Privacy Policy</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="89" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=sm">Site Map</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="67" bgcolor="#FFFFFF" class="sheet"><a href="#">FAQs</a></td>
                              <td width="13" bgcolor="#FFFFFF"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="96" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=c">Contact Us</td>
                              <td width="13" bgcolor="#FFFFFF" class="sheet"><img src="images/bullet.jpg" width="13" height="12" /></td>
                              <td width="75" bgcolor="#FFFFFF" class="sheet"><a href="InvalidateSession.jsp?mode=fb"> Feedback</a></td>
