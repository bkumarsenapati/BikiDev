...
face="Arial" color="red"><B><%= regTag %></B></FONT><b> </b></center>
   ...
   <div id="loginBox" style="margin-top:0px;">  
...
<TD>
             <p><font face="Arial" size="2"><input type="radio"  value="er" id="id_radio1" checked="checked" name="enroll" >&nbsp;Enrichment enrollment&nbsp;&nbsp;<input type="radio" id="id_radio2" value="cr" name="enroll">&nbsp;CreditRecovery enrollment&nbsp;</font></p>
</TD>
</TR></TBODY></TABLE></TD>
</TR>
                </table>
...
class=content_help face="arial" color="red"><span style="font-size:10pt;"><i>(Month, DD, YYYY)</i></span></FONT><span style="font-size:10pt;"><font face="Arial"> </font></span></p>
  ...
  <tr>
    <td height="30"><strong>Credit Card Number: </strong></td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td height="30"><strong>Card Type:</strong></td>
  </tr> 
...
<option value="JCBCard">JCB
  ...
  <tr>
    <td height="30"><strong>Expiry	</strong></td>
  ...
  <tr>
    <td height="30"> <select id="standard-dropdown" name="ExpMon" class="custom-class1 custom-class2">
       ...
       <strong>yy</strong>
       <input type="text" name="cvv"  class="txtpnowid" value="" height="22" valign="middle" width="25" size="10" style="margin-left:10px;"  /> &nbsp;<strong> CVV</strong></td>
  </tr>
  
  
  <tr>
    <td height="30"><strong>Name on the Card: </strong></td>
  </tr>
  ...
  <tr>
    <td height="30"><strong>Address 1: </strong></td>
  </tr>
  ...
  <tr>
    <td height="30"><strong>Address 2: </strong></td>
  </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="257" height="30" align="left"><strong>State:</strong></td>
        <td width="10" align="left" valign="top">&nbsp;</td>
        <td width="323" align="left"><strong>Zip:</strong></td>
      </tr>
      ...
      <tr>
        ...
        <td align="left" valign="top" ><input type="text"  name="zip" class="txtpnowid"   value="" height="22" valign="middle" width="200" size="25"   />
        &nbsp;</td> 
        </table>
