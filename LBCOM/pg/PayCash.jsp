...
%>
  <tr>
    ...
    do is, just <b><a href="#" onclick="Popup=window.open('InvoiceToPrint.jsp','Popup','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=420,height=400,left=430,top=23'); return false;"><u>print your invoice</u></a></b> , visit your school, 
