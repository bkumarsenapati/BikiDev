					  ...
					  while(rs1.next())
					  {
						...
						if(lId.equals(lessonId))
						{
							...
							i++;
								...
								//learnToday=learnToday.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/CB_images/","../slides/images/");
								learnToday=learnToday.replaceAll("%20"," ");
								learnToday=learnToday.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
								...
								//cQuestions=cQuestions.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/CB_images/","../slides/images/");
								cQuestions=cQuestions.replaceAll("%20"," ");
								cQuestions=cQuestions.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
								...
								//matNeed=matNeed.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/CB_images/","../slides/images/");
								matNeed=matNeed.replaceAll("%20"," ");
								matNeed=matNeed.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
								...
								activity=activity.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
								...
								assessment=assessment.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
								...
								assignment=assignment.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../slides/images/");
...
/*
				...
				*/
				...
				if(lessonStatus.equals("1"))
				{
					...
					while(rs2.next())
					{
							...
							z=rs2.getRow();
							//slideContent=slideContent.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/CB_images/","../images/");
					slideContent=slideContent.replaceAll("%20"," ");
					slideContent=slideContent.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/course_bundles/"+courseName+"/slides/images/","../images/");
	...
	public void generateAssignment(String sPath, String courseName, String courseId, String oldURL, String newURL, String aCId, String aTId, String aSId)
	{
		...
		String schoolPath ="C:/Tomcat5/webapps/LBCOM/schools";
		String schoolId=aSId;
		...
		try
		{
			...
			{			
				...
				{					
					...
					assgnContent=rs1.getString("assgn_content");
					//assgnContent=assgnContent.replaceAll("http://oh.learnbeyond.net/LBCOM/coursedeveloper/CB_images/","../images/");
					assgnContent=assgnContent.replaceAll("%20"," ");
