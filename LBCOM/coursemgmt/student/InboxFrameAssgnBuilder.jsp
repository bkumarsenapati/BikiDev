...
<script language="javascript">
	...
	function save()
	{
		...
		//alert(sac);
		document.sub.action="SaveAssignment.jsp?workid=<%=workId%>&workfile=<%=workFile%>&cat=<%=categoryId%>&coursename=<%=courseName%>&submitcount=<%=submitCount%>";
...
<body>
<form name="sub"  method="post" enctype="multipart/form-data" action="SubmitAssignment.jsp?workid=<%=workId%>&workfile=<%=workFile%>&cat=<%=categoryId%>&coursename=<%=courseName%>&submitcount=<%=submitCount%>" onsubmit="return validate();">
