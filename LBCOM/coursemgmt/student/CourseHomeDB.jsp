...
function changesession(cName,cId,sId,stId,stName,clId,mode,type)
{
	...
	$("#nav_main li").removeClass('selected');showLoading('grid');$("#organizer_main").addClass('selected');grid_content.load("/LBCOM/coursemgmt/student/CourseHomeMain.jsp?courseid="+cId+"&coursename="+cName+"&schoolid="+sId+"&studentid="+stId+"&classid="+clId+"&mode="+mode+"&page_type="+type+"&studentname="+stName+"", hideLoading);
...
<table  border="1" style="border:2px outset #eb473b;" style="border-width:2px;"width="95%" align="left" cellspacing="2" bordercolor="#9db38a" cellpadding="2" height="106">
    <tr>
        <td width="670"style="border-right:1px solid #9db38a;" colspan="5" align="left" valign="top"  bgcolor="#9db38a"><font face="Arial" color="FFFFFF"><span style="font-size:11pt;"><b>&nbsp;<img src="/LBCOM/coursemgmt/student/images/book_accept.png" width="24" height="24" border="0" align="absmiddle"> Courses Enrolled</b></span></font></td>
    </tr>
	<tr>
        ...
        <td height="20" bgcolor="#ffea9d" width="53%" background="images/1bg.jpg">
            <p><span style="font-size:10pt;"><font face="Arial"><b>&nbsp;&nbsp;<img src="../coursemgmt/student/images/af_course.jpg" width="16" height="16" border="0" align="absmiddle"> &nbsp;Course Material <br>
</b></font></span></p>
        </td>
        <td height="20" bgcolor="#ffea9d" width="22%" background="images/1bg.jpg">
            <p align="center"><span style="font-size:10pt;"><font face="Arial"><b>
            <img src="../coursemgmt/student/images/af_assignments.jpg" width="16" height="16" border="0" align="absmiddle">
            Assignments</b></font></span></p>
        </td>
        <td height="20" bgcolor="#ffea9d" width="25%" background="images/1bg.jpg">
            <p align="center"><span style="font-size:10pt;"><font face="Arial"><b>
             <img src="../coursemgmt/student/images/af_tick.jpg" width="16" height="16" border="0" align="absmiddle">
            Assessments</b></font></span></p>
        </td>
    </tr>
...
<!--To display the course name, new items in a tabular format   -->
 <!-- <table border="1" width="682" align="center" cellspacing="2" bordercolordark="#333333" bordercolorlight="#333333" bordercolor="#333333">  -->
	<tr>
        ...
        <td height="15" width="47%" bgcolor="#ffffff" style="margin-left:10px; padding-left:10px;">
...
<%
				...
				{	
%>
		<td height="15" width="80" bgcolor="#ffffff" style="padding-left:10px; margin-left:15px;">
...
<%
				...
				{
%>
		<td height="15" width="80" bgcolor="#ffffff" style="padding-left:10px; margin-left:10px;">
...
%>
    ...
    <tr>
        <td width="670" height="40" colspan="5" bgcolor="#E8E8E8"><font face="Arial"><span style="font-size:11pt;"><b>&nbsp;<img src="/LBCOM/coursemgmt/student/images/book_accept.png" width="24" height="24" border="0" align="absmiddle"> Courses Enrolled</b></span></font></td>
    </tr>
	<tr>
