...
<%
	...
	{	 
		...
		for(Enumeration e1 = workIds.elements() ; e1.hasMoreElements() ;)
		{
			...
			rs1=st4.executeQuery("select * from "+masterTable+" where work_id='"+wId+"'");
			if(rs1.next())
			{
...
<table border="1" cellspacing="0" width="500" align="center">
    ...
    <tr>
      <td width="64%" colspan="2" align="center" rowspan="2" height="34">
		...
		<a href="AssignmentEditor.jsp?totrecords=&start=0&cat=all&status=">BACK TO ASSIGNMENTS LIST</a></font>
      </td>
    </tr>
</table>
</center>
