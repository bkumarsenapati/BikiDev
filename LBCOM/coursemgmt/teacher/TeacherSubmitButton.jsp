...
<tr>
	<td width="25%" align="center">
		<b><font face="verdana" size="2"><a href="javascript:showcomments('<%=comments%>');">View Student Comments</font>
	</td>
	<td width="20%" align=center><b>
		<font face="verdana" size="2"><a href="javascript:enterRemarks('<%=remark%>');">Add Remarks</a></font>
	</td>
	<td width="40%">
		<font face="verdana" size="2">Total Points&nbsp;[Max = <%=maxMarks%>] 
<%
	if(status<4)
	{
%>
