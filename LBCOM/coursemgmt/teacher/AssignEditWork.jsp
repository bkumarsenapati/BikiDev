...
<%
	   ...
	   try
		...
		{
			ExceptionsFile.postException("AssgnEditWork.jsp","Operations on database  and reading parameters","SQLException",e.getMessage());
			...
			try{
				...
				ExceptionsFile.postException("AssgnEditWork.jsp","closing statement and connection  objects","SQLException",se.getMessage());
				System.out.println(se.getMessage());
			}
		}
		catch(Exception e){
			ExceptionsFile.postException("AssgnEditWork.jsp","Operations on database  and reading parameters","Exception",e.getMessage());
			out.println(e);
		}
%>
<HTML>
...
<form name="create" enctype="multipart/form-data" action="/LBCOM/coursemgmt.AddWork?mode=mod"  method="POST" onsubmit="return validate();">
<table border="0" width="100%" height="100%" cellspacing="1">
  ...
  <table  border="0" width="65%" cellspacing="0" bordercolorlight="#FFFFFF" height="262" cellpadding="0">
    ...
    <tr>
      ...
      <td width="359" height="23"><font face="Arial" size="2"><input type='text' name='docname' value="<%=docName%>" maxlength='15' oncontextmenu="return false" onkeydown="restrictctrl(this,event)" onkeypress="return AlphaNumbersOnly(this, event)" >
        </font>
      </td>
    </tr>
	<tr>
	...
	try{
		...
		while (rs.next()) {
			...
			ExceptionsFile.postException("AssgnEditWork.jsp","Operations on database  ","Exception",e.getMessage());
...
//			out.println(e);
	...
	<tr>
      <td width="36%" height="23" align="right" bgcolor="#FFFFFF"><font size="2" face="Arial">Assignment Category&nbsp;</font></td>
      <td width="3%" height="23" align="center" bgcolor="#FFFFFF"><b><font size="2" face="Arial">:</font></b></td>
	...
	try
	{
		...
		ExceptionsFile.postException("AssgnEditWork.jsp","operations on resultset","Exception",e.getMessage());
   }finally{
		try{
			if(st!=null)
				st.close();
	...
	<%
	  	if(eval==0){%>
      <td width="359" height="23"><font face="Arial" size="2"><input type=text name=totalmarks value="<%=marksTotal%>"   oncontextmenu="return false" onkeydown="restrictctrl(this,event)" onkeypress="return NumbersOnly(this, event)">
        </font>
      </td>
    <%}else if(eval>0){%>
...
<% 
	...
	<tr>
	<td width="3%" height="23" align="center" bgcolor="#FFFFFF"><b><font size="2" face="Arial">:</font></b></td>
      <td width="68%" bgcolor="#FFFFFF"><input type="file" name="workdoc"></td>
	</tr>
   <tr>
	<td width="3%" height="23" align="center" bgcolor="#FFFFFF"><b><font size="2" face="Arial">:</font></b></td>
	...
	<td width="3%" height="23" align="center" bgcolor="#FFFFFF"><b><font size="2" face="Arial">:</font></b></td>
     <td width="68%" bgcolor="#FFFFFF"><input type="text" name="editorfile" value="" readonly size="20">
       <input type="button" value="HTML Editor..."   name="editfile" onclick="return openEditor('<%=sessid%>','<%=classId%>','<%=courseId%>','<%=workId %>');"></td>
    </tr>
<%}else {%>
	<tr>
	<td width="3%" height="23" align="center" bgcolor="#FFFFFF"><b><font size="2" face="Arial">:</font></b></td>
...
<%}%>
    ...
    <tr>
      <td width="600" colspan="3" height="44">
        <p align="center"><input type="image" name ="modify" border="0" src="../images/modify.gif" width="88" height="35">
		<input type="image" onClick="return cleardata()" src="../images/reset.gif"></p>
      </td>
    </tr>
	<% 
