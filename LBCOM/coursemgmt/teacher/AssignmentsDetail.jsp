...
String docName="",docType="",docId="",Type="";
...
<table border="0" width="100%" height="170" cellspacing="0" align="center" cellpadding="0">
  <tr><td>&nbsp;</td></tr>
  
  <tr>
		<td width="100%" height="15"><span style="font-size:12pt;"><font face="Arial" color="#0F0F0F"><b>
                        Courses >>Status</b></font></span>
		</td>
		<!-- <td width="100%" height="15"><span style="font-size:12pt;"><font face="Arial" color="#0F0F0F"><b>
                        <a href="/LBCOM/coursemgmt/teacher/CoursesList.jsp">Courses</a>>>Status</b></font></span>
		</td> -->
  </tr>
    
  <tr>
      <td width="100%" valign=top>
         <table border="0" width="100%" cellspacing="1" bordercolordark="#FFFFFF" height="77">
	   ...
	   <tr>
			...
			<%  }else{  %>			 
			 ...
			 <% } %>  
			   ...
			   <td bgcolor="#C2CCE0" height="21" colspan="4" align="center"><font color="#000080" face="arial" size="2">
	                 ...
	                 <td bgcolor='#C2CCE0' height='21' colspan="1" align='right' ><font face="arial" size="2">Page&nbsp;
	  		    <% int index=1;
	    			int str=0;
	    			int noOfPages=0;
	    ...
	    <tr>
<%	 
      String bgColor1="#42A2E7",bgColor2="#42A2E7",bgColor3="#42A2E7";
      if(sortingBy.equals("en"))	 
	{      bgColor1 = "#AFCFFE";  }          
	...
	{   bgColor3 = "#AFCFFE";  }
%>	 
        	<td width="27%" height="26" align="center" colspan="1" bgcolor='<%=bgColor1%>'>
	<%
             if((sortingType.equals("A"))&&(sortingBy.equals("en")))
              {
        %>
			<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=D&sortby=en&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_dn_1.gif"></a>
	<%   }else{  %>		
	        	<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=A&sortby=en&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_up_1.gif"></a>
	<%   }  %>		
			<b><font face="Verdana" color="#FFFFFF" size="2">Document</font></b>
		</td>
	        
		<td width="8%" height="26" align="center" colspan="1" bgcolor="#42A2E7">
                  <font face="Verdana" color="#FFFFFF" size="2"><b>Type</b></font><font face="Verdana" size="2">
					</font>
	        </td>
         	
		<td width="11%" height="26" align="center" colspan="1" bgcolor='<%=bgColor2%>'>
	<%
             if((sortingType.equals("A"))&&(sortingBy.equals("io")))
              {
        %>		
			<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=D&sortby=io&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_dn_1.gif"></a>
         <%    }else{
	%>            	
			<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=A&sortby=io&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_up_1.gif"></a>
	<%   }  %>		
		        <b><font face="Verdana" color="#FFFFFF" size="2">From</font></b>
		</td>
	        
		<td width="11%" height="26" align="center" colspan="1" bgcolor='<%=bgColor3%>'>
	<%
             if((sortingType.equals("A"))&&(sortingBy.equals("ld")))
              {
        %>						
			<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=D&sortby=ld&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_dn_1.gif"></a>
	 <%    }else{  %> 		
			<a href="AssignmentsDetail.jsp?start=0&classid=<%=classId%>&classname=<%=className%>&courseid=<%=courseId%>&coursename=<%=courseName%>&sorttype=A&sortby=ld&type=<%=type%>" target="_self">
    			<img border="0" src="images/sort_up_1.gif"></a>
	<%   }   %>		
                      	<b><font face="Verdana" color="#FFFFFF" size="2">To</font></b>
		</td>
                
		<td width="8%" height="26" align="center" colspan="1" bgcolor="#42A2E7">
                       <font face="Verdana" color="#FFFFFF" size="2"><b>Assigned</b></font><font face="Verdana" size="2">
						</font>
                </td>
        
	        <td width="7%" height="26" align="center" colspan="1" bgcolor="#42A2E7">
                       <b><font face="Verdana" color="#FFFFFF" size="2">
						Completed</font></b><font face="Verdana" size="2">
						</font>
                </td>
     
	        <td width="7%" height="26" align="center" colspan="1" bgcolor="#42A2E7">
                       <b><font color="#FFFFFF" face="Verdana" size="2">
						Incomplete</font></b><font face="Verdana" size="2">
						</font>
                </td>
 	        
		<td width="7%" height="26" align="center" colspan="1" bgcolor="#42A2E7">
                      <b>
                      <font face="Verdana" color="#FFFFFF" size="2">Pending </font></b>        
		</td>
                
		<td width="10%" height="26" align="center" colspan="5" bgcolor="#42A2E7">
                       <font face="Verdana" color="#FFFFFF" size="2"><b>Results</b></font><font face="Verdana" size="2">
						</font>
                </td>
             </tr>
...
<% 
	...
	<% 
		...
		if (!flag){
		             if(type.equals("assignment")){
				out.println("<tr><td width='100%' colspan='9' height='21' align='center' bgcolor='#E7E7E7'><font face='Arial' color='#000000' size='2'>Assignments are not available yet.</font> </td></tr>");			
				}else{
				    out.println("<tr><td width='100%' colspan='9' height='21' align='center' bgcolor='#E7E7E7'><font face='Arial' color='#000000' size='2'>Assessments are not available yet.</font> </td></tr>");
				}
		}
...
<SCRIPT LANGUAGE="JavaScript">
        ...
        function go(start, courseId, courseName, classId, className,sortby,sorttype){
			...
			window.location.href="AssignmentsDetail.jsp?courseid="+courseId+"&coursename="+courseName+"&classid="+classId+"&classname="+className+"&start="+ start+"&sortby="+sortby+"&sorttype="+sorttype+"&type="+type;
		return false;
		}
	...
	function assmtAssign(courseId,courseName,classId,className,workId,docType,docName,totRecords){
		window.location.href="AssignNotSubmit.jsp?mode=assign&doctype="+docType+"&docname="+docName+"&classid="+classId+"&classname="+className+"&courseid="+courseId+"&coursename="+courseName+"&workid="+workId+"&start=0&totrecords="+totRecords;
	}
	
	function assmtSubmit(courseId,courseName,classId,className,workId,docType,docName,totRecords){
		window.location.href="SubmitPending.jsp?mode=submit&doctype="+docType+"&docname="+docName+"&classid="+classId+"&classname="+className+"&courseid="+courseId+"&coursename="+courseName+"&workid="+workId+"&start=0&totrecords="+totRecords;
	}

	function assmtNotSubmit(courseId,courseName,classId,className,workId,docType,docName,totRecords){
		window.location.href="AssignNotSubmit.jsp?mode=notsubmit&doctype="+docType+"&docname="+docName+"&classid="+classId+"&classname="+className+"&courseid="+courseId+"&coursename="+courseName+"&workid="+workId+"&start=0&totrecords="+totRecords;
         }

 	function assmtPending(courseId,courseName,classId,className,workId,docType,docName,totRecords){	
		window.location.href="SubmitPending.jsp?mode=pending&doctype="+docType+"&docname="+docName+"&classid="+classId+"&classname="+className+"&courseid="+courseId+"&coursename="+courseName+"&workid="+workId+"&start=0&totrecords="+totRecords;
	}

         function assmtResult(courseId,courseName,classId,className,workId,docType,docName,totRecords){	
	 	window.location.href="Result.jsp?mode=result&doctype="+docType+"&docname="+docName+"&classid="+classId+"&classname="+className+"&courseid="+courseId+"&coursename="+courseName+"&workid="+workId+"&start=0&totrecords="+totRecords;
       }
</SCRIPT>
