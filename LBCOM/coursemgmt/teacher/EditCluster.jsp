...
try
{
	...
	rs = st.executeQuery("select cluster_name from assignment_clusters where cluster_id='"+clid+"' and course_id='"+courseId+"' and school_id='"+schoolId+"' and teacher_id='"+teacherId+"'");
%>
...
<form name="editCluster" method="POST" action="/LBCOM/coursemgmt.AddGroup?mode=edit&clid=<%=clid%>" method="POST" onsubmit="return validate();">
...
%>
	...
	<tr>
		<td colspan=2 align=right width="481" height="47"><p align="center">
        <input type="image" src="../images/submit.jpg" width="103" height="36">
		</td>
	</tr>
</table>
<p>
