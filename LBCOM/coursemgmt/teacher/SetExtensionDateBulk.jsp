...
<%
	...
	System.out.println("select DATE_FORMAT(last_date,'%m/%d/%Y') as last_date,DATE_FORMAT(last_date,'%Y-%m-%d') as last_datedb from coursewareinfo where course_id='"+courseId+"' and school_id='"+schoolId+"'");
...
<form name='duedates' action="ExtendValidityBulk.jsp?workids=<%=workIds%>&studentids=<%=sidStr%>" method="POST" onsubmit="return validate();" >
