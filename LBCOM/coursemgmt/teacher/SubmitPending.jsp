...
try
{
	...
	String sessid=(String)session.getValue("sessid");
	if(sessid==null){
    ...
    if(docType.equals("assignment"))
	   {  
		String q1="",q2="";
		  if(mode.equals("submit")){
			q1="Select count(*) from "+schoolId+"_"+classId+"_"+courseId+"_dropbox where work_id='"+work_id+"' and status >= 2 order by student_id, submit_count LIMIT "+start+","+pageSize;
	        q2="Select student_id, submitted_date, submit_count from "+schoolId+"_"+classId+"_"+courseId+"_dropbox where work_id='"+work_id+"' and status >= 2";
		  }
	      if(mode.equals("pending")){
			q1="Select count(*) from "+schoolId+"_"+classId+"_"+courseId+"_dropbox where work_id='"+work_id+"' and status >= 2";
		    q2="Select student_id, submitted_date, submit_count from "+schoolId+"_"+classId+"_"+courseId+"_dropbox where work_id='"+work_id+"' and status >= 2 and status < 4 order by student_id, submit_count LIMIT "+start+","+pageSize;
		  }
		rs2=st2.executeQuery(q1);
		if(rs2.next()){
			totRecords=rs2.getInt(1);
    ...
    <tr>
     ...
     <tr>
           <td colspan="4" height="15"><font face="Arial" color="#0F0F0F" size="2">
              	<a href="/LBCOM/coursemgmt/teacher/CoursesList.jsp">Courses</a>>><a href="#" onclick="showdoc('<%=courseId%>','<%=courseName%>','<%=classId%>','<%=className%>','<%=docType%>')">Status</a>>><%=docName%></font></td>
...
<table border="0" width="100%" cellspacing="1" bordercolordark="#FFFFFF" height="71">
          <tr>
			...
			<%  }else{  %>			 
			 ...
			 <% } %>  
			   ...
			   <td colspan="2" bgcolor="#C2CCE0" height="21" align="center"><font color="#000080" face="arial" size="2">
	                     <%
			  	    if(start==0){ 
			               		if(totRecords>end){
	    ...
	    <tr>
        	<td width="24%" height="24" bgcolor="#42A2E7">
                       <p align="center">
						<font face="Verdana" color="#FFFFFF" size="2"><b>User Id</b></font><font face="Verdana" size="2">
						</font> </p>
                </td>
		
		<td width="30%" align="center" height="24" bgcolor="#42A2E7">
                      <font face="Verdana" color="#FFFFFF" size="2"><b>Student Name</b></font><font face="Verdana" size="2">
						</font>  
	        </td>
	        
		<td width="10%" height="24" bgcolor="#42A2E7">
                  <p align="center">
					<font face="Verdana" color="#FFFFFF" size="2"><b>Attempt</b></font><font face="Verdana" size="2">
					</font> </p>
	        </td>
         	
		<td width="18%" height="24" bgcolor="#42A2E7">
                  <p align="center">
					<font face="Verdana" color="#FFFFFF" size="2"><b>Submitted on</b></font><font face="Verdana" size="2">
					</font> </p>
	        </td>
         	
				
	        <td width="18%" height="24" bgcolor="#42A2E7" colspan="4">
                       <p align="center">
						<font face="Verdana" color="#FFFFFF" size="2"><b>email</b></font></p>
                </td>
	 ...
	 %>
	    <tr>
			...
			%>
                <td width="24%" height="22" bgcolor="#E7E7E7">
                     <p align="left"><font face="Arial"><span style="font-size: 11pt"><%=id%></span></font>
               </td>
    		
		<td width="30%" height="22" bgcolor="#E7E7E7">
                       <p align="left"><span style="font-size:11pt;"><font face="Arial"><%=studentName%></font></span></p>
                </td>
       
	       <td width="10%" height="22" bgcolor="#E7E7E7">
                    <p align="center"><span style="font-size:11pt;"><font face="Arial"><%=attempt%></font></span></p>
               </td>
	       
	       <td width="18%" height="22" bgcolor="#E7E7E7">
                    <p align="center"><span style="font-size:11pt;"><font face="Arial"><%=submitDate%></font></span></p>
               </td>
	       
                <td width="18%" height="22" bgcolor="#E7E7E7" colspan="5">
                       <p align="center"><span style="font-size:11pt;"><font face="Arial"><a href="#" onclick="sendEmail('<%=email%>')"><%=email%></a></font></span></p>
                </td>
...
<SCRIPT LANGUAGE="JavaScript">
         ...
         function sendEmail(fromUser)
	  {
        ...
        function go(start, courseId, courseName, classId, className,doctype,docname,mode,workId,totRecords){	
			window.location.href="SubmitPending.jsp?courseid="+courseId+"&coursename="+courseName+"&classid="+classId+"&classname="+className+"&start="+ start+"&doctype="+doctype+"&docname="+docname+"&mode="+mode+"&workid="+workId+"&totrecords="+totRecords;
		return false;
	}
