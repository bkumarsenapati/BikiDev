 ...
 <!-- <table border="0" width="100%" cellspacing="1">
  ...
  <table cellspacing="0" width="484" bordercolordark="#48A0E0" bordercolorlight="#48A0E0" style="border-collapse:collapse;" cellpadding="2" height="375">
    ...
    <tr>		
      ...
      <p align="right"><font face="Arial" size="1"><font color="red">*</font> fields are mandatory.</font></td>
    </tr>
	<% if(!stateStandards){%>
	...
	<%}%>
    <tr> 
      <td width="232" height="49"> <b> <font face="Arial" size="2">Description</font><font face="Arial">
      </font></b> </td>
	...
	<%if(!stateStandards){%>
    <tr> 
      <td width="232" height="22"> <b> <font face="Arial" size="2">Class ID</font><font face="Arial">
      </font></b> 
      </td>
...
%>
    ...
    <tr> 
      <td width="232" height="22"><b><font face="Arial" size="2">Session</font></b></td>
      <td width="263" height="22"> 
