...
*/
%>
<iframe src="/LBCOM/coursemgmt/teacher/WaightBox.jsp?courseid=<%=courseId%>&coursename=<%=courseName%>&classid=<%=classId%>&classname=<%=className%>" width="100%" height="500px"></iframe>
