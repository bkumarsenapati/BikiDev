...
{
	window.open("ListAssignments.jsp?workids=<%=workId%>&tblname=<%=masterTable%>","Document","resizable=no,scrollbars=yes,width=350,height=350,toolbars=no");
}
...
<BR>
	  ...
	  The due date of the assignment has been extended to <%=dueDate%> for <a href="#" onclick="listStudents(); return false;"><b><%=sidLen%></b> student(s)</a> successfully.</font>
</body>
</html>
