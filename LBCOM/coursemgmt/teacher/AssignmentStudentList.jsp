		...
		{ 
			...
			else
			{
				/*	out.println("<table border='0' width='100%' cellspacing='1' bordercolordark='#C2CCE0' height='65'>");
					...
					out.println("<tr><td width='741' bgcolor='#C2CCE0' height='21'>      <b><font face='Arial' color='#FF0000' size='2'>Student are not found in </font></b></td></tr></table>");				*/
...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber3" height="1">
  <tr>
    ...
    <img border="0" src="../images/bassign.gif" width="113" height="32"></td>
    <td width="17%" height="1"></td>
    <td width="16%" height="1"></td>
    <td width="34%" height="1">
    <p align="right"><b><font face="Verdana" size="2" color="#0000FF">
    <a href="#" onclick="history.go(-1); return false;">&lt;&lt;BACK</a></font></b></td>
  </tr>
</table>
...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#C0C0C0" width="100%" id="AutoNumber2" height="101">
...
%>
					<tr>
					<td width="3%" bgcolor="#858585" height="21">
...
<%	
				...
				{ 
%>
					<td width="18" height="18" bgcolor="#EFEFEF">
						<font size="2" face="Arial"><input  type="checkbox" name="selids" value="<%=stuId%>"></font>
					</td>
<%				
				}
%>
