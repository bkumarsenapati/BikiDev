...
<BODY>
<form name="desc" method="post" action="CreateFile.jsp?workid=<%=workId%>&cat=<%=categoryId%>&docname=<%=docName%>&foldername=<%=folderName%>" onsubmit=" return check();">
 <br><br><br>
<table border="0" width="100%" cellspacing="1">
  <tr>
    <td width='20%' bgcolor="#BEC9DE" height='21'><b><font size='2' face='Arial' color='#000080'><b> File Name </b></font></td>
	<td  bgcolor='#EEEEEE' height='21'><b><font size='2' face='Arial' color='#000080'><b><input size='75' maxlength='100' name="ftitle" type='text' oncontextmenu="return false" onkeypress="return AlphaNumbersOnly(this, event)" ></b></font></td>
</tr>
<tr>
<td>Create here</td>
</tr>
...
<tr>
        ...
        <td height='19' width='1370'>
         ...
         <textarea rows="3" name="filecontent" id="filecontent" cols="82">&nbsp;</textarea>
