...
<table border="0" width="100%" cellspacing="0"  cellpadding="0">
     ...
     <tr>
	   ...
	   %>
<table border="0" width="100%" cellspacing="1" bordercolordark="#FFFFFF" height="69">
          <tr>
		...
		<td width="13%" height="23" bgcolor="#42A2E7">
                  <p align="center">
		...
		<td width="10%" height="23" bgcolor="#42A2E7">
                       <p align="center"><b>
						<font face="Verdana" color="#FFFFFF" size="2">Points</font></b> </p>
                </td>

	        <td width="15%" height="23" bgcolor="#42A2E7" colspan="5">
                       <p align="center"><b>
						<font face="Verdana" color="#FFFFFF" size="2">E</font></b><font face="Verdana" color="#FFFFFF" size="2"><b>mail</b></font></p>
                </td>
	 ...
	 %>
      ...
      %>	       
               <td width="10%" height="21" bgcolor="#E7E7E7">
                     <p align="center"><font face="Arial"><span style="font-size: 11pt"><a href="javascript://" onclick="return modify_window('<%=urlTemp%>');"><%=marksSecured%></a></span></font>
               </td>
     <%
          } else {
     %>
	       <td width="10%" height="21" bgcolor="#E7E7E7">
                     <p align="center"><font face="Arial"><span style="font-size: 11pt"><%=marksSecured%></span></font>
               </td>
    <%  }  %>
	       
		 <td width="15%" height="21" bgcolor="#E7E7E7" colspan="5">
	 ...
	 function sendEmail(fromUser)
	  {
        ...
        function go(start, courseId, courseName, classId, className,doctype,docname,mode,workId,totRecords){	
			window.location.href="Result.jsp?courseid="+courseId+"&coursename="+courseName+"&classid="+classId+"&classname="+className+"&start="+ start+"&doctype="+doctype+"&docname="+docname+"&mode="+mode+"&workid="+workId+"&totrecords="+totRecords;
		return false;
	}
