...
<title>Content Resources</title>
	...
	<frameset rows="50,*" frameborder=0 framespacing="1" >
		<frame name="top" src="PaTop.jsp?subid=<%=subId%>&idxfile=<%=idxFile%>" scrolling=no >
	...
	%>
		...
		<frame name="bottom" src="/LBCOM/schools/coursecontent/default.htm">

	<%}else { %>

		<frame name="bottom" src="/LBCOM/schools/coursecontent/<%= conGrade %>/<%=subjString %>/<%=idxFile%>">
