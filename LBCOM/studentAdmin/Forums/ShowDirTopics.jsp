...
<table align="center" border="8" cellpadding="0" cellspacing="0" width="100%" bordercolor="#546878" bordercolordark="#546878" bordercolorlight="#546878" bgcolor="#9db38a">
    <tr>
        <td width="35%" bgcolor="#9db38a" height="24">
	...
	}else if(mode1.equals("act"))
{
	...
	%>
        ...
        <td width="20%"  height="24" bgcolor="#9db38a">
...
<%
	try
	{
		...
		rs=st.executeQuery("select forum_name,forum_id,created_by,creator_type,school_id,forum_desc,status,access_code from forum_master where school_id='"+schoolid+"' "+queryStr+" order by forum_id");
		...
		while(rs.next())
		{
			...
			{ 
				...
				int acode = 0;
				if(accessCode.indexOf(accessCourse)!=-1)
				{
					tmp=tmp+1;
				}
			}
			if(tmp==0)
			{
				if(accessCode.indexOf("S:C000")!=-1)
				{
					tmp=tmp+1;
				}
            ...
            <table align="center" cellspacing="0" width="100%" bordercolordark="#E3E3E3" bordercolorlight="#E3E3E3" style="border-collapse:collapse;" cellpadding="0">
                <tr>
                    <td width="35%" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27" align="left">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor="#546878" bordercolordark="#546878" bordercolorlight="#546878" bgcolor="#9db38a">
                            <tr>
                                <td width="14%">
