<html>
<head>
<title>Srikanth G openWYSIWYG | Select Color</title>
</head>
...
var dImage, f;
var copyImage1="/LBCOM/schoolAdmin/Forums/Forum_images/"+type;
...
<form name="frm1" enctype="multipart/form-data" action="/LBCOM/forums.Forum_SaveFile" method="POST" onsubmit="insertVideo();">
