...
var copyImage1="/LBCOM/schoolAdmin/Forums/images/"+type;
		alert(copyImage1);
 /* upto here */
...
<form name="frm1" enctype="multipart/form-data" action="/LBCOM/forums.Forum_SaveFile" method="POST" onsubmit="insertImage();">
