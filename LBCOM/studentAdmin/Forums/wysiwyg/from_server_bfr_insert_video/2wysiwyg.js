...
var ToolbarList = {
	...
	"insertvideo":    ['InsertVideo',          'InsertVideo',        imagesDir + 'insert_video.gif',     imagesDir + 'insert_video_on.gif'],
...
//  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  + '<iframe frameborder="2" id="wysiwyg' + n + '"></iframe>\n'
  + '</td></tr></table>\n';
...
function formatText(id, n, selected) {
  ...
  document.getElementById("wysiwyg" + n).contentWindow.focus();
	...
	var formatIDs = new Array("FontSize","FontName","Bold","Italic","Underline","Subscript","Superscript","Strikethrough","Justifyleft","Justifyright","Justifycenter","InsertUnorderedList","InsertOrderedList","Indent","Outdent","ForeColor","BackColor","InsertImage","InsertVideo","InsertTable","CreateLink");
	...
	if (viewTextMode == 1 && disabled_id == 1) {
      ...
      window.open(popupsDir + 'insert_image.jsp?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=190');
	  }
	  
	  //Insert Video
	  else if (id == "InsertVideo") {
      window.open(popupsDir + 'insert_video.html?wysiwyg=' + n,'popup','location=0,status=0,scrollbars=0,resizable=0,width=400,height=190');
	  }
