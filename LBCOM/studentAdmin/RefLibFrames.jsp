...
<title>Content Resources</title>
	...
	<frameset rows="65,*" frameborder=0 framespacing="1" >
		<frame name="top" src="RefLibTop.jsp" scrolling=no >
		<frame name="bottom" src="/LBCOM/schools/coursecontent/RefLib/RefLib.htm">
	 </frameset>
