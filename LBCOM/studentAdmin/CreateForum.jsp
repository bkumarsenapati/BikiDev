...
<%
	String utype=null,tag=null,bcolor=null,emailid=null,schoolid=null,warn=null;
%>
<html>
      ...
      <table border="0" width="305">
        ...
        <tr>
          <td colspan="2" width="292">
			...
			<img border="0" src="../forums/images/<%= tag %>cancel.gif" width="89" height="36"></a>
			<input type="image" border="0" src="../forums/images/<%= tag %>create.gif" width="88" height="35"></td>
        </tr>
      </table>
    </td>
  </tr>
