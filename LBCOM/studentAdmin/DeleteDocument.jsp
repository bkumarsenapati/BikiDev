...
<%
		if(flist.length!=0)
		{
			for(int i=0;i<flist.length;i++)
			{
				...
				//String httppath="/LBCOM/schools/"+schoolid+"/"+emailid+"/PersonalFolders/"+foldername+"/"+ flist[i];
...
<%
	...
	{
		ExceptionsFile.postException("DeleteDocument.jsp","operations on files","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
