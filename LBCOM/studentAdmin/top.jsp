...
<% 
    ...
    {	
			...
			System.out.println("TOP TOP ....schoolId..."+schoolId);
...
function usermanual(){
	usermanualwindow=window.open("/LBCOM/manuals/learner_UG/","UserManual","resizable=yes,scrollbars,toolbars=no");
}
</SCRIPT>
</head>
...
<img src="../images/hsn/<%=logoName%>" width="219" height="50" border="0" title="<%=schoolId%>"></td>
    ...
    <tr>
        <td width="100%" colspan="3" height="6" bgcolor="#dcdcde">
           
        </td>
    </tr>
    <tr>
        <td bgcolor="#546878" height="24">
            <p><font face="Arial"><span style="font-size:10pt;">&nbsp;</span></font><span style="font-size:10pt;"><font face="Arial" color="white"><!-- <b>Welcome : </b>User Name </b> --></font></span></p>
        </td>
        <td width="380" height="24" bgcolor="#546878">&nbsp;</td>
        <td width="616" height="24" bgcolor="#546878">            <div align="right">
