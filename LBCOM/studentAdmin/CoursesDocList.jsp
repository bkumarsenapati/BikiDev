...
<table border="0" width="100%" bordercolorlight="#000000" cellspacing="0" bordercolordark="#000000" cellpadding="0" >
    <tr>
     ...
     <tr>
     <td width="60%" bgcolor="#C2CCE0" height="21" colspan="7">
      <p align="left"><font size="2" face="Arial"><span class="last">Files <%= (start+1) %> - <%= end %> of <%= totRecords %>&nbsp;&nbsp;</span><font color="#000080">
...
<%
	...
	{
%>
		<td width="40%" bgcolor="#C2CCE0" height="21" colspan="3">
			<p align="right">
...
%>
  ...
  <tr>
    ...
    <td width="150" bgcolor="#CECBCE" height="21" align="center"><b>
		<font size="2" face="Arial" color="#000080">Document Name</font></b>
	</td>
    ...
    <td width="100" bgcolor="#CECBCE" height="21" align="center">
      <font size="2" face="Arial" color="#000080"><b>Created Date</b></font>
    </td>
	<td width="100" bgcolor="#CECBCE" height="21" align="center">
		<font size="2" face="Arial" color="#000080"><b>Assigned To</b></font>
    </td>
	<td width="100" bgcolor="#CECBCE" height="21" align="center">
		<font size="2" face="Arial" color="#000080"><b>Accessed By</b></font>
    </td>
  </tr>
  ...
  <tr>
    <td width="16" height="18" bgcolor="<%=bgColor%>" align="center" valign="middle">
		<font size="2" face="Arial"><input type="checkbox" name="selids" value="<%=workId %>"></font>
	</td>
    <td width="14" height="18" bgcolor="<%=bgColor%>" valign="middle" align="center">
		<font size="2" face="Arial"><a href="#" onclick="return deleteFile('<%= workId %>','<%=categoryId%>')" >
		<img border="0" src="../images/idelete.gif" TITLE="Delete" ></a></font>
	</td>
    <td width="14" height="18" bgcolor="<%=bgColor%>" align="center" valign="middle">
		<font size="2" face="Arial" color="<%=foreColor%>">
...
%>
			...
			<td width="92" height="18" align="left" valign="middle" bgcolor="<%=bgColor%>">
				<font size="2" face="Arial" color="<%=foreColor%>"><%=topic %></font>
			</td>
			<td width="101" height="18" align="left" valign="middle" bgcolor="<%=bgColor%>">
				<font size="2" face="Arial" color="<%=foreColor%>"><%=subtopic %></font>
			</td>
			<td width="100" height="18" align="center" valign="middle" bgcolor="<%=bgColor%>">
				<font size="2" face="Arial" color="<%=foreColor%>"><%=rs.getDate("created_date") %></font>
			</td>
			<td width="100" height="18" align="center" valign="middle" bgcolor="<%=bgColor%>">
				<font size="2" face="Arial" color="<%=foreColor%>"><%=assStu%></font>
			</td>
			<td width="100" height="18"  align="center" valign="middle" bgcolor="<%=bgColor%>">
				<font size="2" face="Arial" color="<%=foreColor%>"><%=viewedStu%></font>
			</td>
		</tr>
<%          
		}
