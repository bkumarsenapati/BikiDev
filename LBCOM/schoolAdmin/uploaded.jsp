...
<%
	...
	String foldername="",adminid="",schoolid="",folderpath="",filepath="",sessid="";
%>
<%
...
%>
  	<tr>
		...
		<a href="javascript://" onclick="na_open_window('win', '<%=httppath%>', 0, 0, 600, 400, 1, 0, 1, 1, 1); return false;" target="_self">
...
<%
	...
	{
		ExceptionsFile.postException("uploades.jsp","operations on files","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
