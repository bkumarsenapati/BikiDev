...
<% 
	String user="",schoolid="",topiccount="",replycount="",views="",maxdate="",dir="",forumid="",crtby="",utype="";
	String fStatusMsg="",fStatus="",fAltMsg="",mode1="",desc="",ruser="",rdate="",UAruser=null,replydate="";
	int forumcount=0;
	Connection con=null;
...
<td width="100%">
	<table border="0" cellpadding="0" cellspacing="0" face='Arial' size='3' style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" align="left">
	  <tr>
		...
		<p align="right"><span style="font-size:10pt;"><font face="Arial" color="blue"><a href="/LBCOM/schoolAdmin/ForumMgmtIndex.jsp?userid=<%=emailid%>&schoolid=<%=schoolid%>" ><b>Forum Management</b></font></span></td>
...
<%
	try
	{
		rs=st.executeQuery("select forum_name,forum_id,created_by,creator_type,status,nov from forum_master where school_id='"+schoolid+"' order by forum_id");
		...
		while(rs.next())
		{
			...
			if(mode1.equals("act") && fStatus.equals("2"))
				{
					flag=false;
				}
