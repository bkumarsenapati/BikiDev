                    ...
                    <td width="39%" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27" align="left">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor="#EEBA4D" bordercolordark="#EEBA4D" bordercolorlight="#EEBA4D">
                            <tr>
                                ...
                                <td width="86%">
                                    <p align="left"><span style="font-size:10pt;"><b><a href="ShowReply1.jsp?fid=<%= forumid %>&user=<%= user1 %>&dir=<%=dir%>&topic=<%= topic %>&postdate=<%= maxdate %>&crtby=<%=crtby%>&utype=<%=utype%>&views=<%=views1%>&desc=<%=desc%>&topiccount=<%=topiccount%>&replycount=<%=replycount%>&ruser=<%=ruser1%>&replydate=<%=replydate1%>"><font face="Arial" color="black"><%= topic1 %></font></a></b></span><font face="Arial"><span style="font-size:10pt;"><br>
