...
String crtby="",topiccount="",ruser="",replydate="",ruser1="",replydate1="",desc="",rdate="",mode1=null,message1="",user2="";
...
<table align="center" border="8" cellpadding="0" cellspacing="0" width="100%" bordercolor="#EEBA4D" bordercolordark="#EEBA4D" bordercolorlight="#EEBA4D">
    <tr>
        <td width="35%" bgcolor="#EEBA4D" height="24">
        ...
        <td width="15%" bgcolor="#EEBA4D" height="24">
            ...
            <table align="center" cellspacing="0" width="100%" bordercolordark="#E3E3E3" bordercolorlight="#E3E3E3" style="border-collapse:collapse;" cellpadding="0">
                <tr>
                    <td width="35%" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27" align="left">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor="#EEBA4D" bordercolordark="#EEBA4D" bordercolorlight="#EEBA4D">
                            <tr>
                                <td width="14%">
					...
					<td width="10%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#546878"><%=views1%></font></span></td>
...
</span></font><font face="Arial" color="#546878"><span style="font-size:9pt;">on&nbsp;<%=replydate%></span></font></p>
                    </td>
                </tr>
				</table>
		</td>
...
<table align="center" border="8" cellpadding="0" cellspacing="0" width="100%" bordercolor="#EEBA4D" bordercolordark="#EEBA4D" bordercolorlight="#EEBA4D">
    <tr>
        <td width="39%" bgcolor="#EEBA4D" height="24">
...
%>
        ...
        <td width="25%" bgcolor="#EEBA4D" height="24">
            <p align="center"><font face="Arial" color="white"><span style="font-size:10pt;"><b>Last Reply Posted</b></span></font></p>
        </td>
    </tr>
        ...
        <td colspan="5" align="center" valign="top" height="25">
            <table align="center" cellspacing="0" width="100%" bordercolordark="#E3E3E3" bordercolorlight="#E3E3E3" style="border-collapse:collapse;" cellpadding="0">
                <tr>
                    <td width="39%" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27" align="left">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" bordercolor="#EEBA4D" bordercolordark="#EEBA4D" bordercolorlight="#EEBA4D">
                            <tr>
                                ...
                                <td width="86%">
                                    <p align="left"><span style="font-size:10pt;"><b><a href="ShowReply1.jsp?sno=<%=sno%>&fid=<%= forumid %>&user=<%= user1 %>&dir=<%=dir%>&topic=<%= topic %>&postdate=<%= maxdate %>&crtby=<%=crtby%>&utype=<%=utype%>&views=<%=views1%>&desc=<%=desc%>&topiccount=<%=topiccount%>&replycount=<%=replycount%>&ruser=<%=ruser1%>&replydate=<%=replydate1%>"><font face="Arial" color="black"><%= topic1 %></font></a></b></span><font face="Arial"><span style="font-size:10pt;"><br>
				   ...
				   <font face="Arial" color="#546878"><%= user1 %></font></span></p>
                    </td>
                    <td width="10%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#546878"><%= replycount %></font></span></td>
...
<%
	...
	replydate1="";
	 ...
	 if(flag==false)
		out.println("<tr><td bgColor=\"#E2E2E2\" colspan=5>&nbsp;</td></tr><tr><td bgColor=\"#E2E2E2\" colspan=5 align=center><-- No Topics Available --></td></tr><tr><td bgColor=\"#E2E2E2\" colspan=5>&nbsp;</td></tr>");
