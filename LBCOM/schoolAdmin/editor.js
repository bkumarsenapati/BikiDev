...
var im3='../schoolAdmin/symbols/Ans1-s.jpg';
var im4='../schoolAdmin/symbols/Ans1-e.jpg';
var im5='../schoolAdmin/symbols/Ans2-s.jpg';
var im6='../schoolAdmin/symbols/Ans2-e.jpg';
var im7='../schoolAdmin/symbols/Ans3-s.jpg';
var im8='../schoolAdmin/symbols/Ans3-e.jpg';
var im9='../schoolAdmin/symbols/Ans4-s.jpg';
var im10='../schoolAdmin/symbols/Ans4-e.jpg';
...
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans1-s.jpg\" onclick=\"Adiinsertimg(this,im3)\">";
html+="</td><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans1-e.jpg\" onclick=\"Adiinsertimg(this,im4)\">";
html+="</td></tr><tr><td>";

html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans2-s.jpg\" onclick=\"Adiinsertimg(this,im5)\">";
html+="</td><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans2-e.jpg\" onclick=\"Adiinsertimg(this,im6)\">";
html+="</td><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans3-s.jpg\" onclick=\"Adiinsertimg(this,im7)\">";
html+="</td><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans3-e.jpg\" onclick=\"Adiinsertimg(this,im8)\">";
html+="</td></tr><tr><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans4-s.jpg\" onclick=\"Adiinsertimg(this,im9)\">";
html+="</td><td>";
html+="<input type=\"image\" src=\"../schoolAdmin/symbols/Ans4-e.jpg\" onclick=\"Adiinsertimg(this,im10)\">";
html+="</td><td>";
...
var stop1im='<IMG src="../schoolAdmin/symbols/Ans1-s.jpg">';
var endop1im='<IMG src="../schoolAdmin/symbols/Ans1-e.jpg">';
var stop2im='<IMG src="../schoolAdmin/symbols/Ans2-s.jpg">';
var endop2im='<IMG src="../schoolAdmin/symbols/Ans2-e.jpg">';
var stop3im='<IMG src="../schoolAdmin/symbols/Ans3-s.jpg">';
var endop3im='<IMG src="../schoolAdmin/symbols/Ans3-e.jpg">';
var stop4im='<IMG src="../schoolAdmin/symbols/Ans4-s.jpg">';
var endop4im='<IMG src="../schoolAdmin/symbols/Ans4-e.jpg">';
...
if(htmlcode.search(stop1im)==-1)
{
alert("Please insert Choice_1s image before starting the choice1");
...
if(htmlcode.search(endop1im)==-1)
{
alert("Please insert Choice_1e image before ending the choice1");
...
if(htmlcode.search(stop2im)==-1)
{
alert("Please insert Choice_2s image before starting the choice2");
...
if(htmlcode.search(endop2im)==-1)
{
alert("Please insert Choice_2e image before ending the choice2");
...
if(htmlcode.search(stop3im)==-1)
{
alert("Please insert Choice_3s image before starting the choice");
...
if(htmlcode.search(endop3im)==-1)
{
alert("Please insert Choice_3e image after ending the choice3");
...
if(htmlcode.search(stop4im)==-1)
{
alert("Please insert Choice_4s image before starting the choice4");
...
if(htmlcode.search(endop4im)==-1)
{
alert("Please insert Choice_4e image aftyer ending the choice4");
...
/*
if(htmlcode.search(findque)==-1)
{
alert("Please write \"startques\" while starting the question");
return false;
}
if(htmlcode.search(findop1)==-1)
{
alert("Please write \"startop1\" while starting the option1");
return false;
}
if(htmlcode.search(findop2)==-1)
{
alert("Please write \"startop2\" while starting the starting the option2");
return false;
}
if(htmlcode.search(findop3)==-1)
{
alert("Please write \"startop3\" while starting the option3");
return false;
}
if(htmlcode.search(findop4)==-1)
{
alert("Please write \"startop4\" while starting the option4");
return false;
}

if(htmlcode.search(findcorrect)==-1)
{
alert("Please write \"correctans\" while starting the correctanswer");
return false;
}
if(htmlcode.search(findend)==-1)
{
alert("Please write \"end\" while end of the correctanswer");
return false;
}
*/
...
window.location.href="/LBRT/servlet/schoolAdmin.Divqueans?m="+htmlcode+"&state="+state+"&subject="+subject+"&grade="+grade+"&topic="+topic+"&schoolid="+schoolid+"&teacherid="+teacherid;
