...
<table border="1" width="564" cellspacing="1" bordercolordark="#FFFFFF"  bordercolor="#111111" height="179" bordercolorlight="#FFFFFF" cellpadding="0" style="border-collapse: collapse">
		...
		<tr>
			<td width="558" height="20" bgcolor="#F9F3DB" align="center" colspan="2">
				<p align="left"><font face="Arial" size="2">Add or edit categories under these four courseware sections</font></td>
		</tr>
		<tr>
		<%
			String test="";
		...
		%>	
			<td width="558" height="21" bgcolor="#EEE0A1" align="center" colspan="2">
				...
				<font face="Arial" size="2">Allow teachers to add or edit categories and weightages for their courses</font>
			</td>
	     </tr>
	    <tr>
			<td width="23" bgcolor="#F9F3DB" align="right" height="21">
				<p>
                <img border="0" src="images/idedit.gif" width="19" height="21" style="cursor:hand" onclick=go('CO')></p>
			</td>
			<td width="531" height="21" bgcolor="#F9F3DB">
				<p><b><font face="Arial" size="2">Course outline</font></b></p>
			</td>
		</tr>
		<tr>
			<td width="23" height="21" bgcolor="#F9F3DB" align="right">
