...
<%
	...
	String dirpath="",foldername="",adminid="",schoolid="",folderpath="",filepath="",sessid="";
%>
...
<table align=center border="0" cellspacing="0" width="75%" id="AutoNumber3"  style="border-collapse: collapse" bordercolor="#111111" cellpadding="0">
	...
	<b><font size="2" face="Verdana"><a href="javascript:deletedoc()">[Delete a document]</font></b>
 	...
 	<tr>
	 	<td colspan=3><hr><p><b><i><center><font face="Verdana" size="2">Your File has been deleted successfully.</font></center></i></b></p><hr></td>
 	</tr>
 	<tr>
...
<%
		if(flist.length!=0)
		{
			for(int i=0;i<flist.length;i++)
			{
				...
				String httppath= "/LBCOM/sessids/"+sessid+"_"+adminid.toLowerCase()+"/"+schoolid+"/"+adminid+"/PersonalFolders/"+foldername+"/"+ flist[i];
				%>
  	<tr>
...
<%
	...
	{
		ExceptionsFile.postException("DeleteDocument.jsp","Operations on database ","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
