...
<tr>
<td width="25%"><span style="font-size:10pt;"><font face="Arial" color="#546878"><a href="/LBCOM/schoolAdmin/Forums/ForumManagement.jsp?mode=findex&userid=<%=user%>&schoolid=<%=schoolid%>" style="color: blue;text-decoration:none"><b>Forum Index</b></a></font></span>
</td>
...
<tr>
<td width="5%" align="center" valign="middle" bgcolor="#EEBA4D" height="24">&nbsp;</td>
<td width="2%" align="center" valign="middle" bgcolor="#EEBA4D" height="24">&nbsp;</td>
<td width="35%" align="left" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>&nbsp;<%= dir %></b>
</font></span></td>
<td width="8%" align="center" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>Author</b>
</font></span></td>
<td width="8%" align="center" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>Replies</b>
</font></span></td>
<td width="10%" align="center" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>Views</b>
</font></span></td>
<td width="25%" align="center" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>Created Date</b>
</font></span></td>
<td width="8%" align="center" valign="middle" bgcolor="#EEBA4D" height="24"><span style="font-size:10pt;"><font face="Arial" color="white"><b>Status</b>
</font></span></td>
</tr>
...
<%
    ...
    <tr>
	 ...
	 <td width="5%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><a href="/LBCOM/schoolAdmin/PostNewThread.jsp?sno=<%=sno%>&utype=<%=utype%>&fid=<%=forumid%>&fname=<%=dir%>&tid=<%=topic%>&mode=edit">
			<img border="0" src="images/button_edit.gif" width="35" height="25" title="Edit Forum" border=0></a></td>
		<td width="2%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><a href="/LBCOM/schoolAdmin/DeleteThread.jsp?mode=delete&sno=<%=sno%>&sid=<%=schoolid%>&fid=<%=forumid%>&topic=<%=topic1%>&user=<%=user1%>&postdate=<%= posteddate %>&dir=<%= dir %>&status=<%=tStatus%>" onclick="return confirm('Are you sure that you want to delete this thread?')"><img border="0" src="images/Tea_del.gif" width="19" height="21" TITLE="Delete Forum" border=0></a></td>
	  ...
	  <%
		  if(status.equals("0"))
		    ...
		    if(!tStatus.equals("2"))
		{%>
		<span style="font-size:10pt;"><font face="Arial" color="green" title="Change Forum Status"><%=tMsgStatus%></font></span>
	  
	  <%
		}
		else
		{%>
		<span style="font-size:10pt;"><font face="Arial" color="red" title="Change Forum Status"><%=tMsgStatus%></font></span>
	  ...
	  if(!tStatus.equals("2"))
		{%>
		<span style="font-size:10pt;"><font face="Arial" color="green" title="Change Forum Status"><a href="/LBCOM/forums/ChangeThreadStatus.jsp?fid=<%=forumid%>&fname=<%=dir%>&status=<%=tStatus%>&status1=<%=status%>&userid=<%=user1%>&sno=<%=sno%>&topic=<%= topic %>"><%=tMsgStatus%></font></span></a>
