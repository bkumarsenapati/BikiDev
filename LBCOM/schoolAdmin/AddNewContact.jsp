...
<% 
   ...
   try
       ...
       {
		   ExceptionsFile.postException("AddNewContact.jsp","reading parameter mname","Exception",me.getMessage());
        mname=" ";
       } 
    ...
    try
       ...
       {
		   ExceptionsFile.postException("AddNewContact.jsp","reading parameter address2","Exception",ae.getMessage());
        address2=" ";
       }
    try
       {      
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter city","Exception",ce.getMessage());
        city=" ";
       }
    ...
    zip=request.getParameter("zip");
     try
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter phone","Exception",pe.getMessage());
         phone=" ";
       }
       try
       {
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter extn","Exception",ee.getMessage());
         extn=" ";
       }
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter mobile","Exception",me.getMessage());
        mobile=" ";
       }
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter pager","Exception",pe.getMessage());
          pager=" ";
       }
       ...
       {
		    ExceptionsFile.postException("AddNewContact.jsp","reading parameter fax","Exception",fe.getMessage());
        fax=" ";
       }
  ...
  try
    {
		...
		if(rs.next())
      out.println("<center><font  size=3 face=\"Arial\">This User already in Your Contact List</font><center>");
    else
    {
     String query="insert into contacts values('"+user+"','"+cemail+"','"+fname+"','"+mname+"','"+lname+"','"+address1+"','"+address2+"','"+city+"','"+state+"','"+country+"','"+zip+"','"+phone+"','"+extn+"','"+mobile+"','"+pager+"','"+fax+"','personal','"+schoolId+"')";
...
{
	 ExceptionsFile.postException("AddNewContact.jsp","operations on database ","Exception",e.getMessage());
  out.println(e);
}
finally
{
	try{
		...
		con.close();
		 ...
		 ExceptionsFile.postException("AddNewContact.jsp","closing connection object","Exception",e.getMessage());
