...
public class BrowsePersonalFile extends HttpServlet
{
    ...
    public void service(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse)
    {
        try
        {
            ...
            String adminid = (String)httpsession.getAttribute("adminid");
            String schoolid = (String)httpsession.getAttribute("schoolid");
			String totalurl = pfPath+"/"+schoolid+"/"+adminid+"/PersonalFolders/"+foldername;
            ...
            pt.println("</head>");
            pt.println("<body>");
            pt.println("<form name=\"fs\" method=\"POST\" enctype=\"multipart/form-data\" action=\"/LBCOM/schoolAdmin.UploadPersonalFile?totalurl="+totalurl+"&foldername="+foldername+"\" onSubmit=\"return checkfld();\">");
            pt.println("<br><br><table align=\"center\"><tr><td colspan=2 bgcolor='#F0B850' align=center><b><font color=\"black\" face=\"Verdana\" size=\"2\">Add a File</font></b></td></tr>");
			...
			pt.println("<tr><td colspan=2>&nbsp;</td></tr>");
            pt.println("<tr><td bgcolor='#F0B850' colspan=2 align=\"center\"><input type=\"submit\" value=\"Upload\" name=\"submit\" style=\"color: #000080\"></td></tr></table>");
