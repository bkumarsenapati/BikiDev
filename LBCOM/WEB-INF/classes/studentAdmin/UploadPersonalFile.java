...
public class UploadPersonalFile extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
			...
			for(; enumeration1.hasMoreElements(); printwriter.println("</pre>"))
			{
				...
				if(file.isFile())
				{
					if((file != null))
					{
						...
						if(total<2080800)
						{
							httpservletresponse.sendRedirect("/LBCOM/studentAdmin/uploaded.jsp?emailid="+emailid+"&schoolid="+schoolid+"&foldername="+foldername+"");
						}
						else
							file.delete();
							httpservletresponse.sendRedirect("/LBCOM/studentAdmin/notuploaded.jsp?emailid="+emailid+"&schoolid="+schoolid+"&foldername="+foldername+"");
					}
				}
				else
					httpservletresponse.sendRedirect("/LBCOM/studentAdmin/notuploaded.jsp?emailid="+emailid+"&schoolid="+schoolid+"&foldername="+foldername+"");
        ...
        catch(Exception exception)
        {
			...
			checksizeoffile=null;
			checksizeoffolder=null;
		}
