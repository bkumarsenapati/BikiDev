...
public class  LMSVariations extends HttpServlet
{
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res) throws IOException,ServletException{
        ...
        try{
			...
			out.println("window.location.href=\"/LBCOM/lbcms/ImpAsessmetns.jsp?totrecords=&start=0&checked=&unchecked&cat=edit&workid="+examId+"&docname="+examName+"\";");
			out.println("</script>");		
