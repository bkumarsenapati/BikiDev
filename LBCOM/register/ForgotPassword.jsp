  ...
  <script>
		   function validate(sform)
		    {  
			  ...
			  if(isUserId(trim( sform.uId.value))==false)
	             {
		          sform.uId.focus();
		         return false;
	             }	
...
<%
 ...
 %>
<FORM name=sform action="/LBCOM/register.ForgotPassword?mode=validateuser" onsubmit="return validate(this);" action="" method=post>
  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="324">
    <tr>
    <td width="20%" height="296">&nbsp;</td>
    <td width="60%" height="296">
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" height="119">
     <TBODY>
	<TR>
	 <TD class=mainhead width=308 colSpan=2 height=27><b>Enter your User ID to retain your password<b>
         </TD>
	</TR>
<%     
...
%>
	<TR class=td>
	 <TD class=tdleft width=308 colSpan=2 height=27><FONT color=#ff0000><p align=right>User Id 
     doesn't exist</p></FONT>
         </TD>
	</TR>
<%
	}
...
%>
	<TR class=td>
	 <TD class=tdleft align=right width=312 height=24> User Id:
         </TD>
	 <TD width=308 height=24><INPUT maxLength=25 name="uId" size="20"> <FONT color=#ff0000>*</FONT>
         </TD>
	</TR>
	<TR class=td>
	 <TD width=588 colSpan=2 height=24><P align=center><INPUT type=submit value="Get password" name=submit> </P>
         </TD>
	</TR>
       </TBODY>
     </TABLE>
