...
<!--
	...
	if(mine){
		...
		popUpsBlocked = true
		popmessage="Popup is blocked in your browser";
	}
	if(mine)mine.close();
	if(!x.cookieEnabled){
		cookiemess="Cookies are disabled on your browser";
	}

	var warn = "";
	if (popUpsBlocked || !x.cookieEnabled) {
		warn = "<font color='red'>You may login, but the application will NOT work properly.</font>";
	}
...
<table style="border-collapse: collapse;" align="center" cellpadding="0" cellspacing="0" width="760">
	...
	<tr>
		<td colspan="3">
		<!--	<a href="#" onclick="callhome();">--><img src="images/index/school_logo.gif" width="85" height="74" alt="logo" title="logo" border="0"><!--</a>--></td>
		<td colspan="2">
	...
	<tr>
		<td colspan="15" background="images/index/pglay_09.gif">
			...
			<p align="center"><span style="font-size: 18pt;"><b>&nbsp;HS TRAINING
</b></span></p></td>
		<td>
...
<form name="homepage" method="post" action="/LBCOM/ValidateUser" onsubmit="return validate(this);">
...
<table border="0" width="98%" align="center">
    <tbody><tr>
        ...
        <td width="259" colspan="2">
            <p align="center"><b>Registered users login here<br>&nbsp;</b></p>
        </td>
...
%>	        	 
	...
	<tr>
		<td colspan="8" rowspan="2" valign="top" align=center>
			<a href="/LBCOM/tech.html#browsers"><span style="font-size: 12pt;">[Browser Specific 
Requirements]</span></a>
			<br>
