...
function openwin(fname){
		...
		//var filePath="../sessids/<%=sessid%>_<%=teacherId%>/<%=schoolId%>/<%=teacherId%>/coursemgmt/<%=courseId%>/exams/<%=examId%>/"+fname;
		top.mid_f.location.href=filePath;		
		top.top_f.location.href="<%=(String)session.getAttribute("schoolpath")%><%=schoolId%>/<%=teacherId%>/coursemgmt/<%=courseId%>/exams/<%=folderName%>/top.html";
		top.btm_f.location.href="<%=(String)session.getAttribute("schoolpath")%><%=schoolId%>/<%=teacherId%>/coursemgmt/<%=courseId%>/exams/<%=folderName%>/answersScriptFile.html";
		return false;
