...
try{
	...
	if (tot.equals("none")){//if tot==none
		  dbString="show tables like '"+tblName+"_quesbody'";
		  ...
		  if(rs.next()){
			if((topicId.equals("none") && subTopicId.equals("none") && qType.equals("none") && difficultLevel==-1 ))
			   ...
			   if(!(subTopicId.equals("none") && qType.equals("none")))
					dbString="select count(*) from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.sub_topic_id='"+subTopicId+"' and s.q_id=q.q_id and s.q_type='"+qType+"' and q.q_type='"+qType+"' and q.status!='2' "+diffQuery+" order by s.q_id";

			   if((subTopicId.equals("none") && qType.equals("none")))
					dbString="select count(*) from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.q_id=q.q_id and q.status!='2'"+diffQuery+" order by s.q_id";

			   if((!subTopicId.equals("none") && qType.equals("none")))
					dbString="select count(*) from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.sub_topic_id='"+subTopicId+"' and s.q_id=q.q_id and q.status!='2'"+diffQuery+" order by s.q_id";

			   if((subTopicId.equals("none") && !qType.equals("none")))
					dbString="select count(*) from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.q_id=q.q_id and s.q_type='"+qType+"' and q.q_type='"+qType+"' and q.status!='2'"+diffQuery+" order by s.q_id";
	   ...
	   if(!(subTopicId.equals("none") && qType.equals("none")))
			dbString="select s.q_id,s.q_type,q.q_body,q.difficult_level from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.sub_topic_id='"+subTopicId+"' and s.q_id=q.q_id and s.q_type='"+qType+"' and q.q_type='"+qType+"' and q.status!='2'"+diffQuery+" order by s.q_id LIMIT "+start+","+pageSize;

	   if((subTopicId.equals("none") && qType.equals("none")))
			dbString="select s.q_id,s.q_type,q.q_body,q.difficult_level from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.q_id=q.q_id and q.status!='2'"+diffQuery+" order by s.q_id LIMIT "+start+","+pageSize;

	   if((!subTopicId.equals("none") && qType.equals("none")))
			dbString="select s.q_id,s.q_type,q.q_body,q.difficult_level from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.sub_topic_id='"+subTopicId+"' and s.q_id=q.q_id and q.status!='2'"+diffQuery+" order by s.q_id LIMIT "+start+","+pageSize;

	   if((subTopicId.equals("none") && !qType.equals("none")))
			dbString="select s.q_id,s.q_type,q.q_body,q.difficult_level from "+tblName+"_sub s, "+tblName+"_quesbody q where s.topic_id='"+topicId+"' and s.q_id=q.q_id and s.q_type='"+qType+"' and q.q_type='"+qType+"' and q.status!='2'"+diffQuery+" order by s.q_id  LIMIT "+start+","+pageSize;
		if((topicId.equals("none") && subTopicId.equals("none") && qType.equals("none"))){
			
			dbString="select s.q_id,s.topic_id,s.sub_topic_id,s.q_type,q.q_body,q.difficult_level from "+tblName+"_quesbody q inner join  "+tblName+"_sub s on s.q_id=q.q_id where q.status!='2'"+diffQuery+" order by q.q_id ";
		}
	rs=st1.executeQuery(dbString);
