...
<%
	...
	String	attemptFlag=request.getParameter("attemptFlag");
	...
	//String dispPath="../schools/"+schoolId+"/"+teacherId+"/coursemgmt/"+courseId+"/exams/"+examId;
...
<SCRIPT LANGUAGE="JavaScript">
 <!--
 var versn='<%=version%>';
 var chances='<%=submissionNo%>';
 var subAllowed='<%=maxAttempts%>';

 var bdyDisplayTag='<%=attemptFlag%>';
