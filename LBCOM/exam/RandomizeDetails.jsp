...
<form name="confirm_frm" action="/LBCOM/exam.Variations?noofgrps=<%=noOfGrps%>&examname=<%=examName%>&examid=<%=examId%>&examtype=<%=examType%>" method="post" onsubmit="return check();">
