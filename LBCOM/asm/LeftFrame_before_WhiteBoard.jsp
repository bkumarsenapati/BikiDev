...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="handler('courseware');" onUnload="closePopups();" >
<div align="left" class="lDiv">
    ...
    <tbody>
	    ...
	    <tbody>
                ...
                <tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('profile');"  name="profile" id="profile">Profile</a></td>
                </tr>
                <tr class="lTRow">
                    <td class="lTCol">
               ...
               <!--  <tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('personaldocs')" name="personaldocs" id="personaldocs">Personal Docs</a></td>
                </tr> -->
                <tr class="lTRow">
                ...
                <tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('courseware');" name="courseware" id="courseware">Courseware Mgr</a></td>
                </tr>
				<tr class="lTRow">
					<td class="lTCol">
						<a href="javascript:handler('contineo');" name="contineo" id="contineo">Content Mgr</a></td>
				</tr>
               <!-- <tr class="lTRow">
		...
		-->
				...
				<tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('newreports');" name="newreports" id="newreports">Reports</a></td>
                </tr>
                <tr class="lTRow">
                ...
                <tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('chat');" name="chat" id="chat">Chat</a></td>
                </tr>
                <tr class="lTRow">
                    <td class="lTCol">
		...
		<tr class="lTRow">
					<td class="lTCol">
						<a href="javascript:handler('webhuddle');" name="webhuddle" id="webhuddle">Virtual Classroom</a></td>
		</tr>
		  </tbody>
            </table>
            </td>
...
//			sw = openPopup("support","http://training.hotschools.net/cAuth/ticketM/?nick="+parent.frames["left"].schoolid+"."+parent.frames["left"].email,650,500);
		...
		//	break;
		case 'bboards1':
			parent.main.location.href="/LBCOM/teacherAdmin/Forums/TecaherForumIndex.jsp?schoolid="+schoolid+"&emailid="+email;
			break;
		case 'backup':
