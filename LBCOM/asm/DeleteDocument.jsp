...
<%
	...
	String dirpath="",foldername="",emailid="",schoolid="",folderpath="",filepath="",sessid="";
%>
...
<%
	...
	{
		ExceptionsFile.postException("DeleteDocument.jsp ","reading parameters and doing file operations","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
