...
function getcourse()
{
	...
	//window.open("/LBCOM/WhiteBoard/WhiteBoard.jsp?courseid="+subcourse+"&schoolid=<%=session.getAttribute("schoolid")%>&emailid=<%=session.getAttribute("emailid")%>","Document WB","resizable=yes,scrollbars=yes,width=200,height=100,toolbars=no,titlebar=yes");
	return false;
}
