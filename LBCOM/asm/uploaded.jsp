...
//  top.topframe.teacherPrivateDocsWin=win;
  win.focus();
}
...
<%@ page language="java" import="java.io.*,java.util.*,java.sql.*,coursemgmt.ExceptionsFile,coursemgmt.ExceptionsFile" %>
<%@ page errorPage = "/ErrorPage.jsp" %>

<%
	File files=null,dir=null;
	String foldername="",emailid="",schoolid="",folderpath="",filepath="",sessid="";
%>
<%
	try
	{
...
function deletedoc()
{
	...
	if(bool==0)
	{
		alert("Please select the document you want to delete");
		return;
	}
}		
...
<%
	...
	{
		ExceptionsFile.postException("uploaded.jsp","operations on files and reading parameters","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
