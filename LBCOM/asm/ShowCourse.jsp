...
<%
String foldername="",teacherid="",schoolid="",teacheridurl="";
ResultSet  rs=null;
Connection con=null;
Statement st=null;
...
//	out.println(teacherid);
	...
	rs=st.executeQuery("select  distinct(course_name) from coursewareinfo where teacher_id='"+teacherid+"' and school_id='"+schoolid+"' and status=1");
