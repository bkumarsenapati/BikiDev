    ...
    <tbody>
		...
		-->
			...
			<td class="lTCol">
				...
				<%@ include file="../chat/LiveUsers.jsp" %>
...
//			sw = openPopup("support","http://training.hotschools.net/cAuth/ticketM/?nick="+parent.frames["left"].schoolid+"."+parent.frames["left"].email,650,500);
		...
		case 'chat':
			...
			//parent.main.location.href="http://oh.learnbeyond.net/~oh/hcl/chat/teacher_online.php?emailid="+email;
			//parent.main.location.href="http://220.227.250.172/chat/sampleb.php?userid="+email;
			win=window.open('http://192.168.1.3:8080/chat/login.jsp?username=<%=session.getAttribute("emailid")%>' ,'imchatteachwin','resizable=yes,scrollbars=yes,width=800,height=550,toolbars=no');
			win.focus();
			break;
		case 'chat1':
