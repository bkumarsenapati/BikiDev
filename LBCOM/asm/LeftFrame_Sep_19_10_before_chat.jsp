...
//			sw = openPopup("support","http://training.hotschools.net/cAuth/ticketM/?nick="+parent.frames["left"].schoolid+"."+parent.frames["left"].email,650,500);
		...
		case 'chat':
			...
			break;
		case 'chat1':
			parent.topframe.chatwindow=window.open('ShowCourseBoards.jsp' ,'nmwindow','status=0,resizable=yes,toolbar=no,menubar=no,titlebar=no,scrollbars=yes,width=1022,height=750');
