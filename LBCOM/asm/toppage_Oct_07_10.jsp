		...
		-->
			<!-- BEGIN Help Center Live Code, ? Michael Bird 2004 -->
				<div id="HCLInitiate" style="position:absolute; z-index:1; top: 40%; left:40%; visibility: hidden;">
					<a href="javascript:initiate_accept()"><img src="//mahoning.hotschools.net/~mahoning/hcl/inc/skins/default/images/lh/initiate.gif" border="0"></a>
					<a href="javascript:initiate_decline()">
					<img src="//mahoning.hotschools.net/~mahoning/hcl/inc/skins/default/images/lh/initiate_close.gif" border="0"></a></div>
					<script type="text/javascript" language="javascript" src="//mahoning.hotschools.net/~mahoning/hcl/lh/live.php?department=Hotschools"></script> 
