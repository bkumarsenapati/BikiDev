...
<div align="left" class="lDiv">
    ...
    <tbody>
		...
		-->
				...
				<tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('newreports');" name="newreports" id="newreports">New Reports</a></td>
                </tr>
                <tr class="lTRow">
				...
				<tr class="lTRow">
                    <td class="lTCol">
                        <a href="javascript:handler('bboards1');" name="bboards1" id="bboards1">New Forums</a></td>
                </tr>
                <tr class="lTRow">
                    <td class="lTCol">
