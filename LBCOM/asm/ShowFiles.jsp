...
function na_open_window(name, url, left, top, width, height, toolbar, menubar, statusbar, scrollbar, resizable)
{
  ...
  parent.parent.topframe.teacherPrivateDocsWin=win;
  win.focus();
}
...
<%
	...
	{
		ExceptionsFile.postException("ShowFiles.jsp","Operations on files and reading parameters ","Exception",e.getMessage());
		out.println(e);
	}
%>
</table>
