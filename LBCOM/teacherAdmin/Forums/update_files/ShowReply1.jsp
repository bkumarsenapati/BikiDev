...
String topic="",topic1="",message1="",reply1="",sno="";
String posteddate=" ";
String posteduser="";
String userid="",temp="";
...
try
{
	...
	response.sendRedirect("ShowReply.jsp?sno="+ sno+"&fid="+forumid+"&user="+posteduser+"&dir="+dir+"&topic="+topic+"&postdate="+posteddate+"&crtby="+crtby+"&utype="+utype+"&views="+views1+"&desc="+desc+"&topiccount="+topiccount+"&replycount="+replycount+"&ruser="+ruser+"&replydate="+replydate+"");
%>
