...
<%
String query2="select message,trans_date,user_id,sno,status,forumattachments from forum_post_topic_reply where forum_id='"+forumid+"' and topic='"+temp+"' and school_id='"+schoolid+"' and trans_type='2'  and topic_id='"+topicid+"' order by trans_date";
		stmt1=con.createStatement();
