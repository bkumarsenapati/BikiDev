...
<%
	try
	{
		rs=st.executeQuery("select forum_name,forum_id,created_by,creator_type,status,nov,forum_desc from forum_master where school_id='"+schoolid+"' order by forum_id");
