...
<table align="center" border="0" cellpadding="0" cellspacing="5" width="100%" bordercolor="black" bordercolordark="black" bordercolorlight="black">
    <tr>
        <td width="50%">
            <P><a href="../PostNewThreadTeach.jsp?mode=addteach&fid=<%= forumid %>&fname=<%=dir%>&crtby=<%=crtby%>&utype=<%=utype%>&desc=<%=desc%>&topiccount=<%=topiccount%>&replycount=<%=replycount%>&ruser=<%=ruser%>&replydate=<%=replydate%>&views=<%=views%>&mode=sree1" Title="Add new topic"><img src="images/button_topic_new.gif" width="96" height="25" border="0"></P></a>
        </td>
        <td width="50%">&nbsp;</td>
    </tr>
</table><BR>
