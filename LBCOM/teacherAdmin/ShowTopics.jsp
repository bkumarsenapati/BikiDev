...
<table  align=center border="0" cellPadding="0" cellSpacing="0" width="100%">
  <tr>
    <td bgColor="#A8B8D0" align=center><font face="Arial" size="2" color="#000000"><b><a href="ShowDirTopics.jsp?emailid=<%= user %>&schoolid=<%= schoolid %>" style="color: #000000;text-decoration:none">Forums</a></b></font></td>
    <td bgColor="#A8B8D0" align=center><font color="#000000" size="2" face="Arial, Arial, Helvetica, sans-serif"> 
      <b><a href="PostNewTopic.jsp?fid=<%= forumid %>&fname=<%=dir%>" style="color: #000000;text-decoration:none">Post New Topic</a></b></font></td>
    <td bgColor="#A8B8D0" align=center><font face="Arial" size="2" color="#000000"><b><a href="PostSug.jsp?fid=<%= forumid %>&fname=<%=dir%>" style="color: #000000;text-decoration:none">Post Suggestions</a></b></font></td>
  </tr>
  <tr>
  ...
  <tr> 
    <td bgColor="#40A0E0" align=center width="35%"><font color=black face="Arial" size="2"><b>Forum: 
      <%= dir %></b></font></td>
    <td bgColor="#40A0E0" align=center width="35%"><font color=black face="Arial" size="2"><b>School: 
      <%= schoolid %></b></font></td>
    <td bgColor="#40A0E0" align="right" width="30%"><a href="ShowDirTopics.jsp?emailid=<%= user %>&schoolid=<%= schoolid %>" style="COLOR: #000080; TEXT-DECORATION: none"><b><font face="Arial" color=black size="2">Back</font></b></a></td>
  </tr>
</table>

<table align=center border="0" cellPadding="0" cellSpacing="1" width="100%">
    <tr>
	  <td bgColor="#A8B8D0" align=left width="25%"><font color="#000000" face="Arial" size="2"><b>&nbsp;Topic</b></font></td>
      <td bgColor="#A8B8D0" align=center width="25%"><font color="#000000" face="Arial" size="2"><b>Posted by</b></font></td>
      <td bgColor="#A8B8D0" align="center" width="25%"><font color="#000000" face="Arial" size="2"><b>Replies</b></font></td>
      <td bgColor="#A8B8D0" align=center width="25%"><font color="#000000" face="Arial" size="2"><b>Posted on</b></font></td>
    </tr>
<%
		...
		try
        {
          ...
          while (rs.next())
          {
		    ...
		    {
				ExceptionsFile.postException("ShowTopics.jsp","tokenizing teh string","Exception",ee.getMessage());
	           out.println(ee+" hhh");
		    }
			%>
     <tr>
...
<%
	...
	finally
    {
		try
        {
			...
			ExceptionsFile.postException("ShowTopics.jsp","closing connection,statement and resultset objects","Exception",e.getMessage());
...
%>
<tr>
	  <td bgColor="#40A0E0" colspan=4 align=left>&nbsp;</td>
</tr>
</table>
</center>
</body>
