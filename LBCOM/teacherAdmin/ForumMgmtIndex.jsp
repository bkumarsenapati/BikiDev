...
<tr>
<td width="25%"><span style="font-size:10pt;"><font face="Arial" color="blue"><a href="/LBCOM/teacherAdmin/Forums/ForumManagement.jsp?mode=findex&userid=<%=emailid%>&schoolid=<%=schoolid%>" style="color: blue;text-decoration:none"><b>Forum Index</b></a></font></span>
</td>
...
<table border="2" cellpadding="0" cellspacing="0" face='Arial' size='3' style="border-collapse: collapse" bordercolor="#660033" width="100%" id="AutoNumber1" align="left">
  ...
  <p align="center"><a href="CreateForum.jsp?utype=teacher&tag=1" Title="Add new forum"><span style="font-size:9pt;"><font face="Arial"><b>Add New Forum</b></font></span></a></p>
		</td>
...
<table align="center" border="8" cellpadding="0" cellspacing="0" width="100%" bordercolor="#429EDF" bordercolordark="#429EDF" bordercolorlight="#429EDF">
  <tr>
    <td width="7%" bgcolor="#429EDF" height="24" colspan="2">&nbsp;</td>
    <td width="44%" bgcolor="#429EDF" height="24">
	...
	<td width="8%" bgcolor="#429EDF" height="24">
...
<%
	try
	{
		rs=st.executeQuery("select * from forum_master where school_id='"+schoolid+"' and CREATED_by='"+emailid+"'  order by forum_id");
...
<tr>
        <td colspan="9" align="center" valign="top" height="25">
			...
			<td width="44%" align="left" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#429EDF"><a href="../teacherAdmin/ShowThreads.jsp?fid=<%=forumid%>&fname=<%=dir%>&status=<%=fStatus%>" style="color: #120000;text-decoration:none" title="<%=dir%>"><b><%=dir%></b></a><br><font face='Arial' size='1' color="#002288">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=forumdesc%><br>&nbsp;</font></span></td>
			...
			<td width="8%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#429EDF"><%=utype%></font></span></td>			
			<td width="8%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#429EDF"><%=noofThreads%></font></span></td>
			<td width="10%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#429EDF"><%=crtDate%></font></span></td>
			<td width="8%" align="center" valign="middle" bgcolor="white" style="border-width:1; border-color:rgb(227,227,227); border-style:double;" height="27"><span style="font-size:10pt;"><font face="Arial" color="#429EDF"> 
				<%
				if(!fStatus.equals("0"))
				{%>
