...
<%
	...
	rs.close();
	rs=st.executeQuery("select grade, username, fname, lname from studentprofile where schoolid='"+schoolId+"'  and grade= any(select distinct(class_id) from coursewareinfo where school_id='"+schoolId+"')");
	int i=0,j=1;
	while (rs.next()) {
