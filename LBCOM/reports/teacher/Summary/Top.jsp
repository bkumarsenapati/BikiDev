...
function gocourse(){
	...
	if((courseid.value!="")&&(classid.value!=""))	
		parent.BodyFrame.location="Body.jsp?m_id=<%=marking_id%>&classid="+classid.value+"&classdes="+classid.options[classid.selectedIndex].text+"&courseid="+courseid.value+"&coursedes="+courseid.options[courseid.selectedIndex].text+"&wb="+wb+"&ba="+ba;
	else
		parent.BodyFrame.location="about:blank";
	}
//-->
