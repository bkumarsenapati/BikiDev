...
%>
<style>
th {font-family: Arial; font-size: 12px; color: black; background-color:#A8B8D1;}
</style>
<SCRIPT LANGUAGE="JavaScript" src="/LBCOM/common/Validations.js"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript">
var df="Student Name,Student IDAssignments,Assessments,Points Possible,Points Secured,Percentage (%)";
...
function download(){
	var x=window.open ('Download.jsp?<%=request.getQueryString()%>','mywindow');
}
function init(){
  ...
  <tr>
	...
	<%	  
		out.println("<select name='nRec'  id='nRec' onchange=\"gotopage(this.value);return false;\"> ");%>
			...
			<option value=<%=no_students%>>All</option>
		</select>
	   &nbsp;Page&nbsp;
	  <%
		int index=1;
...
<table border="0" cellspacing="0"   cellpadding="0" style="border-collapse: collapse">
	  <tr>
		...
		<td height="22" align="right">&nbsp;&nbsp;<a href="javascript:download()">Export</a>&nbsp;&nbsp;</td>
	  </tr>
</table>
...
<TEXTAREA NAME="cvs" style="visibility:hidden"></TEXTAREA>
</FORM>
<%}catch(Exception e){
