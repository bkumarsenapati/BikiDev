...
function go(start,nRec){
	window.location.href="Print_Body.jsp?nrec="+nRec+"&start="+ start+"&m_id=<%=marking_id%>&classid=<%=classId%>&classdes=<%=classdes%>&courseid=<%=courseid%>&coursedes=<%=coursedes%>&wb=<%=wb%>&ba=<%=ba%>"; 
}
...
<table border="1" width="100%" cellspacing="0" cellpadding="0" bordercolordark="black" >
 ...
 <table border="0" cellspacing="0"   cellpadding="0" style="border-collapse: collapse">
	  <tr>
		...
		<td height="22" align="right">&nbsp;&nbsp;<a href="javascript:history.back()">Back</a>&nbsp;&nbsp;</td>
	  </tr>
</table> 
<%
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
<tr>
    ...
    <td align="center">&nbsp;Not Attempted&nbsp;</td>
	<td align="center" width=50>&nbsp;&nbsp;&nbsp;</td>
    <td align="center">&nbsp;-UA-&nbsp;</td>
    <td align="center">&nbsp;Not Assigned&nbsp;</td>
	<td align="center" width=50>&nbsp;&nbsp;&nbsp;</td>
    <td align="center">&nbsp;-NG-&nbsp;</td>
    <td align="center">&nbsp;Not Graded&nbsp;</td>
</tr>
</table>
<%}catch(Exception e){
