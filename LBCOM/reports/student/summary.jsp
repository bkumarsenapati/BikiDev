...
function selectgrade(){
	...
	window.location="summary.jsp?m_id=<%=marking_id%>&wb="+wb+"&ba="+ba;
	return false;
}
function onld(){
...
<table border="0" cellspacing="0" width="813"  bordercolor="#EEBA4D" cellpadding="0" bgcolor="#E08443" >
  <tr>
    ...
    <b><font face="Arial" size="2">&nbsp;<font color="#FFFFFF">Student Name :</font></font></b></td>
    <td width="230" height="19" align="center">
     <font face="Arial" size="2">&nbsp;<b><%=user_id%></b></font></td>
	...
	<font color="#FFFFFF" face="Arial" size="2"></font><font color="#FFFFFF" size="1" face="Arial">Print</font></a></b></td>
  ...
  <tr>
    <td width="400" height="24" bgcolor="#B0A890">
    ...
    <td width="142" height="24" align="center" bgcolor="#B0A890">
