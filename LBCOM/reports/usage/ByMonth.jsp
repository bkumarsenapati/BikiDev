...
<script language="javascript">
	...
	{
	        window.location.href="ByMonth.jsp?studentid="+studentId+"&classid="+classId+"&start="+start;
	        return false;
	}
...
<tr>
 ...
 %>
	    ...
	    <% if((start==0)&(totRecords==0)){    %>  
	        <td width="290">  </td>
	    <%  }else{  %>			 
		<td width="290"><%=studentId%>(&nbsp;<%=fName%>&nbsp;<%=lName%>&nbsp;):&nbsp;<font color="#000080" face="arial" size="2"><%= (start+1) %> - <%= end %> of <%= totRecords %>&nbsp;Months&nbsp;&nbsp;</font>
                	   </td>
	    <% } %>  
