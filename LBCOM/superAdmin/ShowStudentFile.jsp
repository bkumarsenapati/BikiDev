...
<%    
      try  {   
		 ...
		 if (totrecords<=0) {
			   ...
			   rs=st.executeQuery("select work_file,student_id,status,submitted_date,submit_count,marks_secured,comments,remarks from "+schoolId+"_"+classId+"_"+courseId+"_dropbox where work_id='"+workId+"' and status >= 2   order by status,eval_date Asc LIMIT "+start+","+pageSize);
		 }
	  }
