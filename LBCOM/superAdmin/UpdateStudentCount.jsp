...
<%
	...
	String facilityId="",newTotal="";

	try
	{
		facilityId=request.getParameter("fid");
		newTotal=request.getParameter("count");

		System.out.println("Entered into updatecount"+newTotal+"......."+facilityId);

		con = con1.getConnection();    
		st = con.createStatement();
		
		st.executeUpdate("update school_profile set non_staff='"+newTotal+"' where schoolid='"+facilityId+"'");
