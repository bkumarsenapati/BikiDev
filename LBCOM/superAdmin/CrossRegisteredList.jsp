...
function gotopage(totrecords)
{
	...
	else
	{
		...
		parent.bottom.location.href="CrossRegisteredList.jsp?school=<%=searchSchool%>&totalrecords="+totrecords+"&start="+start;
		return false;
	}
}
...
<% 
	...
	{
		query1="select * from studentprofile where crossregister_flag='1' order by schoolid asc";
		query2="select count(*) from studentprofile where crossregister_flag='1'";
	}
	else
	{
		query1="select * from studentprofile where schoolid='"+searchSchool+"' and crossregister_flag='1'";
		query2="select count(*) from studentprofile where schoolid='"+searchSchool+"' and crossregister_flag='1'";
	}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" height="23">
   <tr>
      <td align="right" height="23">
         <p align="left"><font face="Verdana"><b>&nbsp;<font size="4">Cross Registered Students Details</font></b></font></p>
      </td>
