	   ...
	   try
	    {
			...
			rs=st.executeQuery("select doc_name,topic,subtopic,work_file,mark_scheme,marks_total,max_attempts,from_date,to_date,comments,to_days(from_date) fdate,to_days(curdate()) cdate from "+schoolId+"_"+classId+"_"+courseId+"_workdocs where work_id='"+workId+"'");
