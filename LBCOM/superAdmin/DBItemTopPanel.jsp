...
<form name="leftpanel" action="--WEBBOT-SELF--" method="POST">
 <div align="center">
    <center>
  <table border="1" width="100%" cellspacing="0" bordercolordark="#DDEEFF">
    <tr>
      <td width="337" bgcolor="#EFEFF7" bordercolor="#EFEFF7" ><b><font face="Arial" size="2" color="#FF65CE">
	...
	<!--  <option value="add">...Add / Modify...</option> -->
	 ...
	 %>
      ...
      <td width="150" bgcolor="#EFEFF7" ><a href="#" onclick="return go('C');"><font color="#800080" size="2" face="Arial">Create</font></a></td>
      <td width="150" bgcolor="#EFEFF7" ><a href="#" onclick="return go('L')"><font color="#800080" size="2" face="Arial">List </font></a></td>
      <td width="351" bgcolor="#EFEFF7" >
