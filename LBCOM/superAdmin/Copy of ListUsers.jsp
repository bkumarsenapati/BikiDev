...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111" height="23">
   ...
   <tr>
      ...
      <td align="right" height="23"><font face="verdana" size="2"><b>Number of Active  Users: <%=au%></b></font></td>
   </tr>
   <tr>
      <td align="right" height="23">
         <p align="left"><font face="Verdana"><b>&nbsp;<font size="2">&nbsp;</font></b></font></p>
      </td>
      <td align="right" height="23"><font face="verdana" size="2"><b>Number of Inactive  Users: <%=iu%></b></font></td>
   </tr>
</table>
  </center>
</div>
...
<%
		   ...
		   if(status.equals("1")){ status="Active";}else{ status="Inactive";}
%>
	  <td width="10" align="left" height="1"><font size="2" face="verdana"><%=status%></font></td>
<%
			}	
%>
   </tr>
