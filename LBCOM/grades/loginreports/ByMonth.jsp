...
<table border="1" cellspacing="0" width="95%" id="AutoNumber1"  bordercolor="#E3E4FA" cellpadding="0" bordercolorlight="#808000" style="border-collapse: collapse" align="center">
 ...
 <% 
    ...
    while(rs2.next())
	{
			...
			rs3=st3.executeQuery("select other_time from usage_detail where school_id='"+schoolId+"' and student_id='"+studentId+"' and month(use_date)='"+month+"' and year(use_date)='"+year+"' and class_id='"+classId+"' and course_id='other' and use_date='"+useDate+"'");
			if(rs3.next())
			{
