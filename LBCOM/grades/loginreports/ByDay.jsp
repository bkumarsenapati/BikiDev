...
<%
    ...
    String schoolId="",classId="",studentId="",courseId="",sessionId="";
...
<table border="1" cellspacing="0" width="90%" id="AutoNumber1"  bordercolor="#E3E4FA" cellpadding="0" bordercolorlight="#808000" style="border-collapse: collapse" align="center">
 ...
 <% 
    ...
    while(rs2.next())
	{
			...
			rs3=st3.executeQuery("select other_time from usage_detail where school_id='"+schoolId+"' and student_id='"+studentId+"' and class_id='"+classId+"' and course_id='other' and use_date='"+dayId+"' and session_id='"+sessionId+"'");
				if(rs3.next())
				{
