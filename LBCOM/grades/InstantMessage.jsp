...
%>
<%
	String userId="",schoolId="",attachFlag="",fromUser="",loginType="", studentId="";
 ...
 function validate()
	{
				  ...
				  if(subject.length==0||subject==null){
		            ...
		            document.composeform.action = "Sent.jsp?subject="+subject+"&studentid="+studentId+"&toadd="+toadd;	 
	        return true;
				   }
	}      
	function attachwin()
...
<tr>
	<td width="90%" height="18" align="center"  bgcolor="#EEE5DE">
		<font face="Arial" size="2" color="#000000"><b>Instant Mail - </b></font>
		<font face="Arial" size="1">Plain Text</font>
	</td>
</tr>
</table>
...
<tr>
	<td width="15%" align="right"><font face="Arial" size="2">To:</font></td>
	<td width="85%">
		<input type="text" name="toadd" id="toaddress" value="<%=studentId%>@<%=schoolId%>" size="60" readonly>
		&nbsp;&nbsp;&nbsp; &nbsp;
 </td>
</tr>
<tr>
	<td width="15%" align="right"><font face="Arial" size="2">Subject:</font></td>
	<td width="85%">
...
<tr>
	<td width="15%" align="right"><font face="Arial" size="2">Attachments:</font></td>
	<td width="85%">
