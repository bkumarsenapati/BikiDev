...
function goCourse()
{
	...
	document.location.href="CourseStudents.jsp?courseid="+crsid;
...
function goPreference()
{
	...
	var crsid=document.coursestudents.courselist.value;
	document.location.href="CourseStudents.jsp?courseid="+crsid+"&pref="+pref;
}
//-->
</SCRIPT>
</head>
...
<%
		...
		rs1=st1.executeQuery("select distinct s.username,s.fname,s.lname from coursewareinfo_det c,studentprofile s where c.school_id='"+schoolId+"' and c.course_id='"+crsId+"' and c.school_id=s.schoolid and s.username!='C000_vstudent' order by "+sortStr+"");
