...
<%
	...
	try
	{
		...
		rs=st.executeQuery("SELECT * from class_grades where schoolid='"+schoolId+"' ORDER BY classid");
%>
...
<table border="0" bordercolor="#111111" width="90%" bgcolor="#429EDF" height="24">
  <tr>
    <td width="50%" height="24">
		<b><font face="Arial" size="2" color="#FFFFFF">Grading Schema</font></b>
	</td>
...
<tr>
	<td width="50%" bgcolor="#96C8ED" align="center">
		<b><font face="Arial" size="2">Grade Code</font></b>
	</td>
	<td width="50%" bgcolor="#96C8ED" align="center">
		<b><font face="Arial" size="2">Minimum Percentage</font></b>
	</td>
</tr>
<%
		int i=0;
...
%>
		<!-- <tr>
		<td width="50%"><%=rs.getString("classid")%></td></tr> -->
		<tr>
		<td width="50%">
		<font face="Arial" size="2"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=rs.getString("grade_code")%></b></font>&nbsp;</td>
		<td width="50%" align="center">
					<font face="Arial" size="2"><%=report.trimFloat(Float.parseFloat(rs.getString("minimum")))%></font> &nbsp;</td>
			</tr>
<%
		}	
		if(i==0)
...
%>
			<tr>
				<td width="100%" colspan="2">
					<font face="Arial" size="2">No grading schema available.</font>
				</td>
			</tr>
<%
		}	
