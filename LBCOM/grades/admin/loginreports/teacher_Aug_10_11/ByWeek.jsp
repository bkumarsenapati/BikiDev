 ...
 <% 
     ...
     while(stk2.hasMoreTokens()){
			...
			{	studyTime = rs2.getInt(1);
				...
				rs3=st3.executeQuery("select other_time from usage_detail where school_id='"+schoolId+"' and student_id='"+studentId+"' and class_id='"+classId+"' and course_id='other' and use_date='"+tempDate+"'");
				if(rs3.next())
				{
