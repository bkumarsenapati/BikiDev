     ...
     while(stk2.hasMoreTokens())
		{
						...
						System.out.println("select sum(study_time), sum(asmt_time), sum(asgn_time), sum(eclass_time), sum(chat_time), sum(other_time) from usage_teach_detail where school_id='"+schoolId+"' and teacher_id='"+teacherId+"' and use_date='"+tempDate+"' and class_id='"+classId+"' and course_id='"+courseId+"' order by use_date");
