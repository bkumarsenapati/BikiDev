...
<%
	...
	rs=st.executeQuery("select distinct s.grade,s.username,s.fname,s.lname from studentprofile s,coursewareinfo_det d,coursewareinfo c  where d.school_id='"+schoolId+"' and d.course_id=c.course_id and s.username=d.student_id and c.teacher_id='"+teacherId+"' and crossregister_flag in(0,1,2) and grade= any(select distinct(class_id) from coursewareinfo where teacher_id='"+teacherId+"' and school_id='"+schoolId+"') order by d.student_id");
