...
%>
<table border="0" cellspacing="0" width="95%" id="AutoNumber3" bgcolor="#429EDF" style="border-collapse: collapse" bordercolor="#111111" cellpadding="0" >
  <tr>
...
function change(grade1)
{
	...
	else
	{
		alert("Select Grade")
		grades='no';
		location.href="OverallSummary.jsp?userid=<%=teacherId%>";						
	}
}
function clear1() {
		var i;
