...
<%
	...
	int totRecords=0,start=0,end=0,c=0,pageSize=10,currentPage=0,flag=0;
%>
...
<form name="sessionreport">
 ...
 %>
	    ...
	    <% if((start==0)&(totRecords==0)){    %>  
	        <td width="290">  </td>
	    <%  }else{  %>			 
		<td width="290"><font color="#000080" face="arial" size="2"><%= (start+1) %> - <%= end %> of <%= totRecords %>&nbsp;Sessions&nbsp;&nbsp;</font>
                	   </td>
	    <% } %>  
