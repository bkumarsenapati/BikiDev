...
%>
	...
	<td width="30%" height="23"  bgcolor="#96C8ED" align="center">
...
<%
				rs1=st1.executeQuery("select  fname,lname,con_emailid,grade from studentprofile where username='" +studentId +"'" );
				while(rs1.next())
					{
...
<tr>
  ...
  <tr>
   ...
   <!--  <td width="2%"><font face="verdana" size="2">
    ...
    <td width="25%">
	<p align="Left"><font face="verdana"size="2"><%=report.trimFloat(percent)%>%&nbsp;&nbsp;<b>Grade:</b>&nbsp;<%=grade%></font></p></td>
  </tr>
</table>
<%
...
<%
		...
		{
			System.out.println("Error:  SBCScores-" + e.getMessage());
		}
	finally
	{
		try
