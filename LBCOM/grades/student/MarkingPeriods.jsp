...
<table border="0" bordercolor="#111111" width="90%" bgcolor="#429EDF" height="24">
  <tr>
    <td width="50%" height="24">
		<b><font face="Verdana" size="2" color="#FFFFFF">Marking Periods</font></b>
	</td>
...
<tr>
	<td width="50%" bgcolor="#96C8ED">
		<b>
		<font face="Verdana" size="2">&nbsp;&nbsp;Marking Period Name</font> </b>
	</td>
	<td width="25%" bgcolor="#96C8ED" align="center">
		<p align="center"><b>
		<font face="Verdana" size="2">Start Date</font> </b>
	</td>
	<td width="25%" bgcolor="#96C8ED" align="center">
		<p align="center"><b>
		<font face="Verdana" size="2">End Date</font> </b>
	</td>
</tr>
<%
		int i=0;
...
%>
			<tr>
				<td width="50%">
					<font face="Verdana" size="2">&nbsp;&nbsp;<%=rs.getString("m_name")%></font> &nbsp;</td>
				<td width="25%" align="center">
					<font face="Verdana" size="2"><%=rs.getString("s_date")%></font> &nbsp;</td>
				<td width="25%" align="center">
					<font face="Verdana" size="2"><%=rs.getString("e_date")%></font> &nbsp;</td>
			</tr>
<%
		}	
		if(i==0)
...
%>
			<tr>
				<td width="100%" colspan="3">
					<font face="Verdana" size="2">There are no Marking Periods.</font>
				</td>
			</tr>
<%
		}	
