...
<table border="0" width="90%" bgcolor="#429EDF" bordercolor="#111111" height="28">
  <tr>
    <td width="50%" height="24"><FONT SIZE="2" face="Verdana" COLOR="#990000">&nbsp;Course Name :</FONT><b>
    <font face="Verdana" size="2" color="#FFFFFF"><%=rs.getString("course_name")%></font></b></td>
...
<tr>
    <td width="80%" height="10" colspan="6" bgcolor="#FFFFFF">
    <hr color="#F16C0A"></td>
  </tr>
  <tr >
    ...
    <td width="19%" height="23"><FONT SIZE="2" face="Verdana" COLOR="#990000">Teacher Name :</FONT>
    ...
    <p align="center"><b><font face="Arial" size="2" color="white">ByAttempt:&nbsp;&nbsp;</font></b><FONT SIZE="2" COLOR="#800000"><B><%=percentageByAttempt%>%</B></FONT>&nbsp;&nbsp;<font face="Arial" size="2" color="white"><b>Grade:</b></font>&nbsp;&nbsp;<FONT SIZE="2" COLOR="#800000"><B><%=gradeByAttempt%></B></FONT></td>
   ...
   <td width="20%" height="1">
    <p align="center"><font color="#FFFFFF" face="Verdana" size="2"><div id="<%=courseId%>"></div></td>
		  ...
		  <SCRIPT LANGUAGE="JavaScript">
						...
						document.getElementById("<%=courseId%>").innerHTML="<b>&nbsp;&nbsp;&nbsp;<font color=#FFFFFF face='Verdana' size='2'>Total:</font>&nbsp;&nbsp;</b></font><b><font color=#800000 face='Verdana' size='2'><%=report.trimFloat(percentageTotal)%>%&nbsp;<font color=#FFFFFF face='Verdana' size='2'>Grade:</font>&nbsp;<%=grade%></font></b>";
	...
	while(rs2.next())
				{
					...
					if(rs2.getString("activity_type").equals("AS"))
						...
						//out.print(rs2.getString("activity_sub_type"));
...
%>
 <tr>
    <td width="25%" height="19" align="center"><font face="Verdana" size="2">&nbsp;<B>Total :</B></font></td>
...
<%
		...
		try
		{
			...
			ExceptionsFile.postException("StudentScores.jsp","closing statement and connection  objects","SQLException",se.getMessage());
